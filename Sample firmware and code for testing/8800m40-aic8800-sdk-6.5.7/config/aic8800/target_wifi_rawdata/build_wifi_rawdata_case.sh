...
python ../../../tools/scons.py -u . PRODUCT=host-wifi PLF=aic8800 BT=armgcc_4_8 BUILD_CMD="$0 $*" TGT_MODE=wifi_rawdata WIFI_RAM_VER=on FLASH_FW=on PMIC_VER=lite FHOST_APP=rawdata BAND5G=on TGTNAME=host_wb_rawdata_ram $opt
