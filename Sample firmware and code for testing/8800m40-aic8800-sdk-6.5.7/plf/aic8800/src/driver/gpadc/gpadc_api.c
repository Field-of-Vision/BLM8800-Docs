...
{
    if (((gpbidx >= 0) && (gpbidx <= 7)) || (gpbidx == 13)) {
...
int gpadc_diff_read_ham(int gpbdiffch, int negflag)
{
    ...
    if (gpbdiffch < GPADC_DIFF_CH_NUM) {
        ...
        #if PLF_PMIC_VER_AUD
        PMIC_MEM_MASK_WRITE((unsigned int)(&aic1000audMsadc->cfg_msadc_ana_ctrl0),
            (AIC1000AUD_MSADC_CFG_ANA_MSADC_TEST_MODE |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_SDM_MODE | AIC1000AUD_MSADC_CFG_ANA_MSADC_IBIAS_BIT(0x2) |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_CHOP_EN | AIC1000AUD_MSADC_CFG_ANA_MSADC_SDM_GAIN_BIT |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_DEM_EN(0x3) | AIC1000AUD_MSADC_CFG_ANA_MSADC_ADC_FF_EN),
            (AIC1000AUD_MSADC_CFG_ANA_MSADC_TS_MODE | AIC1000AUD_MSADC_CFG_ANA_MSADC_TEST_MODE |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_SDM_MODE | AIC1000AUD_MSADC_CFG_ANA_MSADC_IBIAS_BIT(0x7) |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_CHOP_EN | AIC1000AUD_MSADC_CFG_ANA_MSADC_SDM_GAIN_BIT |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_DEM_EN(0x3) | AIC1000AUD_MSADC_CFG_ANA_MSADC_ADC_FF_EN));
        PMIC_MEM_MASK_WRITE((unsigned int)(&aic1000audMsadc->cfg_msadc_sw_ctrl1),
        ...
        while(PMIC_MEM_READ((unsigned int)(&aic1000audMsadc->cfg_msadc_int_raw)) != 0x1);
        PMIC_MEM_WRITE((unsigned int)(&aic1000audMsadc->cfg_msadc_int_raw), 0x1);
        rdata_0  = PMIC_MEM_READ((unsigned int)(&aic1000audMsadc->cfg_msadc_ro_acc));
        PMIC_MEM_MASK_WRITE((unsigned int)(&aic1000audMsadc->cfg_msadc_ana_ctrl0),
            (AIC1000AUD_MSADC_CFG_ANA_MSADC_SDM_MODE | AIC1000AUD_MSADC_CFG_ANA_MSADC_IBIAS_BIT(0x2) |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_CHOP_EN | AIC1000AUD_MSADC_CFG_ANA_MSADC_SDM_GAIN_BIT |
             AIC1000AUD_MSADC_CFG_ANA_MSADC_DEM_EN(0x3) | AIC1000AUD_MSADC_CFG_ANA_MSADC_ADC_FF_EN),
        ...
        while(PMIC_MEM_READ((unsigned int)(&aic1000audMsadc->cfg_msadc_int_raw)) != 0x1);
        PMIC_MEM_WRITE((unsigned int)(&aic1000audMsadc->cfg_msadc_int_raw), 0x1);
        rdata_1  = PMIC_MEM_READ((unsigned int)(&aic1000audMsadc->cfg_msadc_ro_acc));
        #endif
...
int gpadc_measure(int type)
{
    ...
    if (type == GPADC_TYPE_VBAT) {
        ret = msadc_volt_measure(MSADC_VOLT_VBAT);
    } else if (type == GPADC_TYPE_VIO) {
        ret = msadc_volt_measure(MSADC_VOLT_VIO);
    } else if (type == GPADC_TYPE_TEMP0) {
        ret = msadc_temp_measure(MSADC_TEMP_CHIP);
    }
    return ret;
}
#endif
