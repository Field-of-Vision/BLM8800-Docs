...
# BLE_APP_HID         : off/on
python ../../../tools/scons.py -u . PRODUCT=host-wb PLF=aic8800mc BT=armgcc_4_8 BUILD_CMD="$0 $*" \
        TGT_MODE=ble_wifi TGTNAME=host_wb_ble_wifi_aic8800mc \
        ...
        ROM_VER=auto AON=off CHKSUM=off HEAP_SIZE=0x20000 \
        SOFTAP=on PING=on IPERF=on WIFI_RAM_VER=off FHOST_APP=console $opt
