...
enum hci_opcode
{
    ...
    #ifndef HCI_DBG_RD_MEM_CMD_OPCODE
    HCI_DBG_RD_MEM_CMD_OPCODE                   = 0xFC01,
    #endif

    #ifndef HCI_DBG_WR_MEM_CMD_OPCODE
    HCI_DBG_WR_MEM_CMD_OPCODE                   = 0xFC02,
    #endif
    #ifndef HCI_DBG_DEL_PAR_CMD_OPCODE
    ...
    #ifndef HCI_DBG_RD_PAR_CMD_OPCODE
    HCI_DBG_RD_PAR_CMD_OPCODE                   = 0xFC09,
    #endif
    #ifndef HCI_DBG_WR_PAR_CMD_OPCODE
    HCI_DBG_WR_PAR_CMD_OPCODE                   = 0xFC0A,
    #endif
    #ifndef HCI_DBG_WLAN_COEX_CMD_OPCODE
    HCI_DBG_WLAN_COEX_CMD_OPCODE                = 0xFC0B,
    #endif
    #ifndef HCI_DBG_WLAN_COEXTST_SCEN_CMD_OPCODE
    ...
    #ifndef HCI_DBG_RD_KE_STATS_CMD_OPCODE
    HCI_DBG_RD_KE_STATS_CMD_OPCODE              = 0xFC10,
    #endif

    #ifndef HCI_DBG_PLF_RESET_CMD_OPCODE
    HCI_DBG_PLF_RESET_CMD_OPCODE                = 0xFC11,
    #endif

    #ifndef HCI_DBG_RD_MEM_INFO_CMD_OPCODE
    ...
    #ifndef HCI_CMD_SET_BLE_ADDR
    HCI_CMD_SET_BLE_ADDR                        = 0xFC32,
    #endif
    ...
    #ifndef HCI_DBG_RF_REG_RD_CMD_OPCODE
    HCI_DBG_RF_REG_RD_CMD_OPCODE                = 0xFC39,
    #endif

    #ifndef HCI_DBG_RF_REG_WR_CMD_OPCODE
    ...
    #endif //RW_DEBUG
    HCI_VSC_UPDATE_CONFIG_INFO_CMD_OPCODE          = 0xFC72,
};
...
///HCI LE Set AIC Extended Scan Command parameters structure
struct hci_le_set_aic_ext_scan_cmd
{
    uint16_t aic_config_id;
    uint16_t length;
    uint8_t ext_adv_report_to_legacy_en;
    uint8_t dummy[31];
};
