...
typedef enum {
    ...
    PMIC_PWRBT_POS_IRQn     = 2,
    PMIC_PWRBT_NEG_IRQn     = 3,
    PMIC_IRQ_NUMBER
} PMIC_IRQ_T;
...
typedef enum {
    PMIC_GPIO_HOLD_BIT_A0_3         = (0x01 << 0),
    PMIC_GPIO_HOLD_BIT_A4_9         = (0x01 << 1),
    PMIC_GPIO_HOLD_BIT_A10_15       = (0x01 << 2),
    PMIC_GPIO_HOLD_BIT_B0_7         = (0x01 << 3),
} PMIC_GPIO_HOLD_BIT_T;

#define PMIC_GPIO_HOLD_ALL_BITS     (PMIC_GPIO_HOLD_BIT_A0_3 | \
                                     PMIC_GPIO_HOLD_BIT_A4_9 | \
                                     PMIC_GPIO_HOLD_BIT_A10_15 | \
                                     PMIC_GPIO_HOLD_BIT_B0_7)
