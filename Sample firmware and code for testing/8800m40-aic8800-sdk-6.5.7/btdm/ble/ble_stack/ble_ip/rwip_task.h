...
enum TASK_API_ID
{
    ...
    TASK_ID_SMARTCONFIG  = 66,   // Smart Config Task

    TASK_ID_AUDTRANSMITS = 67,   // Aud Transmit Service Server Task
    TASK_ID_AUDTRANSMITC = 68,   // Aud Transmit Service Client Task

    TASK_ID_UDFC         = 99,   // User Defined Service Client Task
    TASK_ID_UDFS         = 100,  // User Defined Service Server Min Task

    TASK_ID_UDFS_MAX     = 200,  // User Defined Service Server Max Task
