...
#define PWM_PWM2_RUN               (1<<8)
#define PWM_PWM2_MODE_SEL          (1<<9)
...
//PWM0_CNT
#define PWM_PWM0_MOD(n)            (((n)&0xFF)<<0)
#define PWM_PWM0_DUTY(n)           (((n)&0xFF)<<8)
...
//PWM1_CNT
#define PWM_PWM1_MOD(n)            (((n)&0xFF)<<0)
#define PWM_PWM1_DUTY(n)           (((n)&0xFF)<<8)
...
//PWM2_CNT
#define PWM_PWM2_MOD(n)            (((n)&0xFF)<<0)
#define PWM_PWM2_DUTY(n)           (((n)&0xFF)<<8)
