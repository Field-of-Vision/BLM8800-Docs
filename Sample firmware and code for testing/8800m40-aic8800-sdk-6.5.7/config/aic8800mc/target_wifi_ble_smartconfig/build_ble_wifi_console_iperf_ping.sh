...
python ../../../tools/scons.py -u . PRODUCT=host-wb PLF=aic8800mc BT=armgcc_4_8 BUILD_CMD="$0 $*" AON=off \
        ...
        BT_BLE=on BT_AUDIO=off APPS=on BLE_ONLY=on BT_USER=on TGTNAME=btdm_wifi_ble \
        ...
        SOFTAP=on IPERF=on PING=on CHKSUM=off WIFI_RAM_VER=off WIFI_ENGINEERING_MODE=off\
        ROM_VER=auto HEAP_SIZE=0xe000 \
