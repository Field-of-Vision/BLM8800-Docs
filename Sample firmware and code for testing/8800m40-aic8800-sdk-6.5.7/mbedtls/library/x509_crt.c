...
static int x509_info_subject_key_identifiter( char *buf,
                                size_t size, const mbedtls_x509_buf *serial )
{
    int ret;
    size_t i, n, nr;
    char *p;
                   ...
                   const mbedtls_x509_crt *crt )
{
    ...
    if( crt->ext_types & MBEDTLS_X509_EXT_SUBJECT_KEY_IDENTIFIER )
    {
        ...
        if( ( ret = x509_info_subject_key_identifiter( p, n,
                                             &crt->subject_key_id ) ) != 0 )
            return( ret );
    }
...
int mbedtls_x509_crt_info_1( char *buf, size_t size, const char *prefix,
                   const mbedtls_x509_crt *crt )
{
    int ret;
    size_t n;
...
int mbedtls_x509_crt_info_2( char *buf, size_t size, const char *prefix,
                   const mbedtls_x509_crt *crt )
{
    int ret;
    size_t n;
...
int mbedtls_x509_crt_info_3( char *buf, size_t size, const char *prefix,
                   const mbedtls_x509_crt *crt )
{
    int ret;
    size_t n;
...
int mbedtls_x509_crt_info_4( char *buf, size_t size, const char *prefix,
                   const mbedtls_x509_crt *crt )
{
    int ret;
    size_t n;
                     ...
                     mbedtls_x509_crt_restart_ctx *rs_ctx )
{
    ...
    *flags = 0;
    ...
    // This version is not support now.
