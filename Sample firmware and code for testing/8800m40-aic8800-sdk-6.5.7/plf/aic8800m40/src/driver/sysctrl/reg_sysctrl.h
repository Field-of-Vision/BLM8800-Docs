...
typedef struct {
  ...
  __IO uint32_t                          cfg_usb_gpio;                 //0x00000040
  __IO uint32_t                          cfg_cpu_p_rxev;               //0x00000044
  __IO uint32_t                          cfg_cpu_s0_rxev;              //0x00000048
  __IO uint32_t                          cfg_cpu_nmi_en;               //0x0000004C
  __IO uint32_t                          ro_top_tports;                //0x00000050
  __IO uint32_t Reserved_00000054[43];                //0x00000054
...
//cfg_cpu_p_rxev
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_BT_DMA_EN      (1<<0)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_BT_DMA_EN_POS  (0)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_BT_UART_EN      (1<<1)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_BT_UART_EN_POS  (1)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PWRCTRL_EN      (1<<2)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PWRCTRL_EN_POS  (2)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PMU_RTC0_EN      (1<<3)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PMU_RTC0_EN_POS  (3)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PMU_RTC1_EN      (1<<4)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PMU_RTC1_EN_POS  (4)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_GPIOB_EN      (1<<5)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_GPIOB_EN_POS  (5)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_AON_PWM_EN      (1<<6)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_AON_PWM_EN_POS  (6)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_UART0_EN      (1<<7)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_UART0_EN_POS  (7)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_UART1_EN      (1<<8)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_UART1_EN_POS  (8)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_UART2_EN      (1<<9)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_UART2_EN_POS  (9)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_DMA_EN      (1<<10)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_DMA_EN_POS  (10)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_USB_DMA_EN      (1<<11)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_USB_DMA_EN_POS  (11)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PWM_EN      (1<<12)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PWM_EN_POS  (12)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_GPIOA_EN      (1<<13)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_GPIOA_EN_POS  (13)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_SPI_EN      (1<<14)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_SPI_EN_POS  (14)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PCIE_EN      (1<<15)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PCIE_EN_POS  (15)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_TRNG_EN      (1<<16)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_TRNG_EN_POS  (16)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_I2CM_EN      (1<<17)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_I2CM_EN_POS  (17)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_SDMMC_EN      (1<<18)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_SDMMC_EN_POS  (18)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PSI_MST_EN      (1<<19)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PSI_MST_EN_POS  (19)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_USB_READY_EN      (1<<20)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_USB_READY_EN_POS  (20)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PCIE_READY_EN      (1<<21)
#define CPU_SYS_CTRL_CFG_CPU_P_RXEV_PCIE_READY_EN_POS  (21)

//cfg_cpu_s0_rxev
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_BT_DMA_EN      (1<<0)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_BT_DMA_EN_POS  (0)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_BT_UART_EN      (1<<1)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_BT_UART_EN_POS  (1)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PWRCTRL_EN      (1<<2)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PWRCTRL_EN_POS  (2)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PMU_RTC0_EN      (1<<3)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PMU_RTC0_EN_POS  (3)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PMU_RTC1_EN      (1<<4)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PMU_RTC1_EN_POS  (4)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_GPIOB_EN      (1<<5)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_GPIOB_EN_POS  (5)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_AON_PWM_EN      (1<<6)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_AON_PWM_EN_POS  (6)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_UART0_EN      (1<<7)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_UART0_EN_POS  (7)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_UART1_EN      (1<<8)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_UART1_EN_POS  (8)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_UART2_EN      (1<<9)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_UART2_EN_POS  (9)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_DMA_EN      (1<<10)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_DMA_EN_POS  (10)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_USB_DMA_EN      (1<<11)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_USB_DMA_EN_POS  (11)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PWM_EN      (1<<12)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PWM_EN_POS  (12)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_GPIOA_EN      (1<<13)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_GPIOA_EN_POS  (13)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_SPI_EN      (1<<14)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_SPI_EN_POS  (14)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PCIE_EN      (1<<15)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PCIE_EN_POS  (15)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_TRNG_EN      (1<<16)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_TRNG_EN_POS  (16)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_I2CM_EN      (1<<17)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_I2CM_EN_POS  (17)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_SDMMC_EN      (1<<18)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_SDMMC_EN_POS  (18)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PSI_MST_EN      (1<<19)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PSI_MST_EN_POS  (19)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_USB_READY_EN      (1<<20)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_USB_READY_EN_POS  (20)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PCIE_READY_EN      (1<<21)
#define CPU_SYS_CTRL_CFG_CPU_S0_RXEV_PCIE_READY_EN_POS  (21)
...
#define CPU_SYS_CTRL_HCLK_RAM0_MANUAL_ENABLE      (1<<5)
#define CPU_SYS_CTRL_HCLK_RAM0_MANUAL_ENABLE_POS  (5)
#define CPU_SYS_CTRL_HCLK_RAM1_MANUAL_ENABLE      (1<<6)
#define CPU_SYS_CTRL_HCLK_RAM1_MANUAL_ENABLE_POS  (6)
#define CPU_SYS_CTRL_HCLK_RAM2_MANUAL_ENABLE      (1<<7)
#define CPU_SYS_CTRL_HCLK_RAM2_MANUAL_ENABLE_POS  (7)
#define CPU_SYS_CTRL_HCLK_RAM3_MANUAL_ENABLE      (1<<8)
#define CPU_SYS_CTRL_HCLK_RAM3_MANUAL_ENABLE_POS  (8)
#define CPU_SYS_CTRL_HCLK_RAM4_MANUAL_ENABLE      (1<<9)
#define CPU_SYS_CTRL_HCLK_RAM4_MANUAL_ENABLE_POS  (9)
#define CPU_SYS_CTRL_HCLK_RAM5_MANUAL_ENABLE      (1<<10)
#define CPU_SYS_CTRL_HCLK_RAM5_MANUAL_ENABLE_POS  (10)
#define CPU_SYS_CTRL_HCLK_RAM6_MANUAL_ENABLE      (1<<11)
#define CPU_SYS_CTRL_HCLK_RAM6_MANUAL_ENABLE_POS  (11)
...
#define CPU_SYS_CTRL_HCLK_PCIE_MANUAL_ENABLE      (1<<29)
#define CPU_SYS_CTRL_HCLK_PCIE_MANUAL_ENABLE_POS  (29)
...
#define CPU_SYS_CTRL_HCLK_RAM0_MANUAL_DISABLE      (1<<5)
#define CPU_SYS_CTRL_HCLK_RAM0_MANUAL_DISABLE_POS  (5)
#define CPU_SYS_CTRL_HCLK_RAM1_MANUAL_DISABLE      (1<<6)
#define CPU_SYS_CTRL_HCLK_RAM1_MANUAL_DISABLE_POS  (6)
#define CPU_SYS_CTRL_HCLK_RAM2_MANUAL_DISABLE      (1<<7)
#define CPU_SYS_CTRL_HCLK_RAM2_MANUAL_DISABLE_POS  (7)
#define CPU_SYS_CTRL_HCLK_RAM3_MANUAL_DISABLE      (1<<8)
#define CPU_SYS_CTRL_HCLK_RAM3_MANUAL_DISABLE_POS  (8)
#define CPU_SYS_CTRL_HCLK_RAM4_MANUAL_DISABLE      (1<<9)
#define CPU_SYS_CTRL_HCLK_RAM4_MANUAL_DISABLE_POS  (9)
#define CPU_SYS_CTRL_HCLK_RAM5_MANUAL_DISABLE      (1<<10)
#define CPU_SYS_CTRL_HCLK_RAM5_MANUAL_DISABLE_POS  (10)
#define CPU_SYS_CTRL_HCLK_RAM6_MANUAL_DISABLE      (1<<11)
#define CPU_SYS_CTRL_HCLK_RAM6_MANUAL_DISABLE_POS  (11)
...
#define CPU_SYS_CTRL_HCLK_PCIE_MANUAL_DISABLE      (1<<29)
#define CPU_SYS_CTRL_HCLK_PCIE_MANUAL_DISABLE_POS  (29)
...
#define CPU_SYS_CTRL_HCLK_SRAM0_LOW_MANUAL_ENABLE      (1<<2)
#define CPU_SYS_CTRL_HCLK_SRAM0_LOW_MANUAL_ENABLE_POS  (2)
#define CPU_SYS_CTRL_HCLK_SRAM0_HIGH_MANUAL_ENABLE      (1<<3)
#define CPU_SYS_CTRL_HCLK_SRAM0_HIGH_MANUAL_ENABLE_POS  (3)
#define CPU_SYS_CTRL_HCLK_SRAM1_LOW_MANUAL_ENABLE      (1<<4)
#define CPU_SYS_CTRL_HCLK_SRAM1_LOW_MANUAL_ENABLE_POS  (4)
#define CPU_SYS_CTRL_HCLK_SRAM1_HIGH_MANUAL_ENABLE      (1<<5)
#define CPU_SYS_CTRL_HCLK_SRAM1_HIGH_MANUAL_ENABLE_POS  (5)
...
#define CPU_SYS_CTRL_HCLK_SRAM0_LOW_MANUAL_DISABLE      (1<<2)
#define CPU_SYS_CTRL_HCLK_SRAM0_LOW_MANUAL_DISABLE_POS  (2)
#define CPU_SYS_CTRL_HCLK_SRAM0_HIGH_MANUAL_DISABLE      (1<<3)
#define CPU_SYS_CTRL_HCLK_SRAM0_HIGH_MANUAL_DISABLE_POS  (3)
#define CPU_SYS_CTRL_HCLK_SRAM1_LOW_MANUAL_DISABLE      (1<<4)
#define CPU_SYS_CTRL_HCLK_SRAM1_LOW_MANUAL_DISABLE_POS  (4)
#define CPU_SYS_CTRL_HCLK_SRAM1_HIGH_MANUAL_DISABLE      (1<<5)
#define CPU_SYS_CTRL_HCLK_SRAM1_HIGH_MANUAL_DISABLE_POS  (5)
...
#define CPU_SYS_CTRL_OTHERS_AUX_PCIE_MANUAL_ENABLE      (1<<0)
#define CPU_SYS_CTRL_OTHERS_AUX_PCIE_MANUAL_ENABLE_POS  (0)
#define CPU_SYS_CTRL_OTHERS_SDMMC_MANUAL_ENABLE      (1<<1)
#define CPU_SYS_CTRL_OTHERS_SDMMC_MANUAL_ENABLE_POS  (1)
#define CPU_SYS_CTRL_OTHERS_FLASH_MANUAL_ENABLE      (1<<2)
#define CPU_SYS_CTRL_OTHERS_FLASH_MANUAL_ENABLE_POS  (2)
#define CPU_SYS_CTRL_OTHERS_TIME0_MANUAL_ENABLE      (1<<3)
#define CPU_SYS_CTRL_OTHERS_TIME0_MANUAL_ENABLE_POS  (3)
#define CPU_SYS_CTRL_OTHERS_TIME1_MANUAL_ENABLE      (1<<4)
#define CPU_SYS_CTRL_OTHERS_TIME1_MANUAL_ENABLE_POS  (4)
#define CPU_SYS_CTRL_OTHERS_UART0_MANUAL_ENABLE      (1<<5)
#define CPU_SYS_CTRL_OTHERS_UART0_MANUAL_ENABLE_POS  (5)
#define CPU_SYS_CTRL_OTHERS_UART1_MANUAL_ENABLE      (1<<6)
#define CPU_SYS_CTRL_OTHERS_UART1_MANUAL_ENABLE_POS  (6)
#define CPU_SYS_CTRL_OTHERS_UART2_MANUAL_ENABLE      (1<<7)
#define CPU_SYS_CTRL_OTHERS_UART2_MANUAL_ENABLE_POS  (7)
#define CPU_SYS_CTRL_OTHERS_SDIO_MANUAL_ENABLE      (1<<8)
#define CPU_SYS_CTRL_OTHERS_SDIO_MANUAL_ENABLE_POS  (8)
#define CPU_SYS_CTRL_OTHERS_PWM_MANUAL_ENABLE      (1<<9)
#define CPU_SYS_CTRL_OTHERS_PWM_MANUAL_ENABLE_POS  (9)
#define CPU_SYS_CTRL_OTHERS_RTC_ALWAYS_MANUAL_ENABLE      (1<<10)
#define CPU_SYS_CTRL_OTHERS_RTC_ALWAYS_MANUAL_ENABLE_POS  (10)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG0_MANUAL_ENABLE      (1<<11)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG0_MANUAL_ENABLE_POS  (11)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG1_MANUAL_ENABLE      (1<<12)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG1_MANUAL_ENABLE_POS  (12)
#define CPU_SYS_CTRL_OTHERS_AUDIO_PROC_MANUAL_ENABLE      (1<<13)
#define CPU_SYS_CTRL_OTHERS_AUDIO_PROC_MANUAL_ENABLE_POS  (13)
#define CPU_SYS_CTRL_OTHERS_PROCESS_MON_MANUAL_ENABLE      (1<<14)
#define CPU_SYS_CTRL_OTHERS_PROCESS_MON_MANUAL_ENABLE_POS  (14)
#define CPU_SYS_CTRL_OTHERS_BCK_0_MANUAL_ENABLE      (1<<15)
#define CPU_SYS_CTRL_OTHERS_BCK_0_MANUAL_ENABLE_POS  (15)
#define CPU_SYS_CTRL_OTHERS_BCK_1_MANUAL_ENABLE      (1<<16)
#define CPU_SYS_CTRL_OTHERS_BCK_1_MANUAL_ENABLE_POS  (16)
#define CPU_SYS_CTRL_OTHERS_SPDIF_MANUAL_ENABLE      (1<<17)
#define CPU_SYS_CTRL_OTHERS_SPDIF_MANUAL_ENABLE_POS  (17)
#define CPU_SYS_CTRL_OTHERS_SPI_MANUAL_ENABLE      (1<<18)
#define CPU_SYS_CTRL_OTHERS_SPI_MANUAL_ENABLE_POS  (18)
#define CPU_SYS_CTRL_OTHERS_MSADC_MANUAL_ENABLE      (1<<19)
#define CPU_SYS_CTRL_OTHERS_MSADC_MANUAL_ENABLE_POS  (19)
#define CPU_SYS_CTRL_OTHERS_EFUSE_MANUAL_ENABLE      (1<<20)
#define CPU_SYS_CTRL_OTHERS_EFUSE_MANUAL_ENABLE_POS  (20)
#define CPU_SYS_CTRL_OTHERS_1M_PCIE_MANUAL_ENABLE      (1<<21)
#define CPU_SYS_CTRL_OTHERS_1M_PCIE_MANUAL_ENABLE_POS  (21)
#define CPU_SYS_CTRL_OTHERS_USBC_MANUAL_ENABLE      (1<<22)
#define CPU_SYS_CTRL_OTHERS_USBC_MANUAL_ENABLE_POS  (22)

//others_manual_disable
#define CPU_SYS_CTRL_OTHERS_AUX_PCIE_MANUAL_DISABLE      (1<<0)
#define CPU_SYS_CTRL_OTHERS_AUX_PCIE_MANUAL_DISABLE_POS  (0)
#define CPU_SYS_CTRL_OTHERS_SDMMC_MANUAL_DISABLE      (1<<1)
#define CPU_SYS_CTRL_OTHERS_SDMMC_MANUAL_DISABLE_POS  (1)
#define CPU_SYS_CTRL_OTHERS_FLASH_MANUAL_DISABLE      (1<<2)
#define CPU_SYS_CTRL_OTHERS_FLASH_MANUAL_DISABLE_POS  (2)
#define CPU_SYS_CTRL_OTHERS_TIME0_MANUAL_DISABLE      (1<<3)
#define CPU_SYS_CTRL_OTHERS_TIME0_MANUAL_DISABLE_POS  (3)
#define CPU_SYS_CTRL_OTHERS_TIME1_MANUAL_DISABLE      (1<<4)
#define CPU_SYS_CTRL_OTHERS_TIME1_MANUAL_DISABLE_POS  (4)
#define CPU_SYS_CTRL_OTHERS_UART0_MANUAL_DISABLE      (1<<5)
#define CPU_SYS_CTRL_OTHERS_UART0_MANUAL_DISABLE_POS  (5)
#define CPU_SYS_CTRL_OTHERS_UART1_MANUAL_DISABLE      (1<<6)
#define CPU_SYS_CTRL_OTHERS_UART1_MANUAL_DISABLE_POS  (6)
#define CPU_SYS_CTRL_OTHERS_UART2_MANUAL_DISABLE      (1<<7)
#define CPU_SYS_CTRL_OTHERS_UART2_MANUAL_DISABLE_POS  (7)
#define CPU_SYS_CTRL_OTHERS_SDIO_MANUAL_DISABLE      (1<<8)
#define CPU_SYS_CTRL_OTHERS_SDIO_MANUAL_DISABLE_POS  (8)
#define CPU_SYS_CTRL_OTHERS_PWM_MANUAL_DISABLE      (1<<9)
#define CPU_SYS_CTRL_OTHERS_PWM_MANUAL_DISABLE_POS  (9)
#define CPU_SYS_CTRL_OTHERS_RTC_ALWAYS_MANUAL_DISABLE      (1<<10)
#define CPU_SYS_CTRL_OTHERS_RTC_ALWAYS_MANUAL_DISABLE_POS  (10)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG0_MANUAL_DISABLE      (1<<11)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG0_MANUAL_DISABLE_POS  (11)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG1_MANUAL_DISABLE      (1<<12)
#define CPU_SYS_CTRL_OTHERS_RTC_WDG1_MANUAL_DISABLE_POS  (12)
#define CPU_SYS_CTRL_OTHERS_AUDIO_PROC_MANUAL_DISABLE      (1<<13)
#define CPU_SYS_CTRL_OTHERS_AUDIO_PROC_MANUAL_DISABLE_POS  (13)
#define CPU_SYS_CTRL_OTHERS_PROCESS_MON_MANUAL_DISABLE      (1<<14)
#define CPU_SYS_CTRL_OTHERS_PROCESS_MON_MANUAL_DISABLE_POS  (14)
#define CPU_SYS_CTRL_OTHERS_BCK_0_MANUAL_DISABLE      (1<<15)
#define CPU_SYS_CTRL_OTHERS_BCK_0_MANUAL_DISABLE_POS  (15)
#define CPU_SYS_CTRL_OTHERS_BCK_1_MANUAL_DISABLE      (1<<16)
#define CPU_SYS_CTRL_OTHERS_BCK_1_MANUAL_DISABLE_POS  (16)
#define CPU_SYS_CTRL_OTHERS_SPDIF_MANUAL_DISABLE      (1<<17)
#define CPU_SYS_CTRL_OTHERS_SPDIF_MANUAL_DISABLE_POS  (17)
#define CPU_SYS_CTRL_OTHERS_SPI_MANUAL_DISABLE      (1<<18)
#define CPU_SYS_CTRL_OTHERS_SPI_MANUAL_DISABLE_POS  (18)
#define CPU_SYS_CTRL_OTHERS_MSADC_MANUAL_DISABLE      (1<<19)
#define CPU_SYS_CTRL_OTHERS_MSADC_MANUAL_DISABLE_POS  (19)
#define CPU_SYS_CTRL_OTHERS_EFUSE_MANUAL_DISABLE      (1<<20)
#define CPU_SYS_CTRL_OTHERS_EFUSE_MANUAL_DISABLE_POS  (20)
#define CPU_SYS_CTRL_OTHERS_1M_PCIE_MANUAL_DISABLE      (1<<21)
#define CPU_SYS_CTRL_OTHERS_1M_PCIE_MANUAL_DISABLE_POS  (21)
#define CPU_SYS_CTRL_OTHERS_USBC_MANUAL_DISABLE      (1<<22)
#define CPU_SYS_CTRL_OTHERS_USBC_MANUAL_DISABLE_POS  (22)

//hclk_soft_resetn_set
#define CPU_SYS_CTRL_HRESETN_ROM_SET      (1<<0)
#define CPU_SYS_CTRL_HRESETN_ROM_SET_POS  (0)
#define CPU_SYS_CTRL_HRESETN_SRAM0_SET      (1<<1)
#define CPU_SYS_CTRL_HRESETN_SRAM0_SET_POS  (1)
#define CPU_SYS_CTRL_HRESETN_SRAM1_SET      (1<<2)
#define CPU_SYS_CTRL_HRESETN_SRAM1_SET_POS  (2)
#define CPU_SYS_CTRL_HRESETN_SRAM2_SET      (1<<3)
#define CPU_SYS_CTRL_HRESETN_SRAM2_SET_POS  (3)
#define CPU_SYS_CTRL_HRESETN_SRAM3_SET      (1<<4)
#define CPU_SYS_CTRL_HRESETN_SRAM3_SET_POS  (4)
#define CPU_SYS_CTRL_HRESETN_SRAM4_SET      (1<<5)
#define CPU_SYS_CTRL_HRESETN_SRAM4_SET_POS  (5)
#define CPU_SYS_CTRL_HRESETN_SRAM5_SET      (1<<6)
#define CPU_SYS_CTRL_HRESETN_SRAM5_SET_POS  (6)
#define CPU_SYS_CTRL_HRESETN_SRAM6_SET      (1<<7)
#define CPU_SYS_CTRL_HRESETN_SRAM6_SET_POS  (7)
...
#define CPU_SYS_CTRL_HRESETN_PCIE_SET      (1<<19)
#define CPU_SYS_CTRL_HRESETN_PCIE_SET_POS  (19)
#define CPU_SYS_CTRL_HRESETN_AUD_PROC_SET      (1<<20)
#define CPU_SYS_CTRL_HRESETN_AUD_PROC_SET_POS  (20)
#define CPU_SYS_CTRL_HRESETN_MAILBOX_SET      (1<<21)
#define CPU_SYS_CTRL_HRESETN_MAILBOX_SET_POS  (21)
#define CPU_SYS_CTRL_HRESETN_SDIO_SET      (1<<22)
#define CPU_SYS_CTRL_HRESETN_SDIO_SET_POS  (22)
#define CPU_SYS_CTRL_HRESETN_MM_SYS_SET      (1<<23)
#define CPU_SYS_CTRL_HRESETN_MM_SYS_SET_POS  (23)
#define CPU_SYS_CTRL_HRESETN_SDMMC_SET      (1<<24)
#define CPU_SYS_CTRL_HRESETN_SDMMC_SET_POS  (24)

//hclk_soft_resetn_clr
#define CPU_SYS_CTRL_HRESETN_ROM_CLEAR      (1<<0)
#define CPU_SYS_CTRL_HRESETN_ROM_CLEAR_POS  (0)
#define CPU_SYS_CTRL_HRESETN_SRAM0_CLEAR      (1<<1)
#define CPU_SYS_CTRL_HRESETN_SRAM0_CLEAR_POS  (1)
#define CPU_SYS_CTRL_HRESETN_SRAM1_CLEAR      (1<<2)
#define CPU_SYS_CTRL_HRESETN_SRAM1_CLEAR_POS  (2)
#define CPU_SYS_CTRL_HRESETN_SRAM2_CLEAR      (1<<3)
#define CPU_SYS_CTRL_HRESETN_SRAM2_CLEAR_POS  (3)
#define CPU_SYS_CTRL_HRESETN_SRAM3_CLEAR      (1<<4)
#define CPU_SYS_CTRL_HRESETN_SRAM3_CLEAR_POS  (4)
#define CPU_SYS_CTRL_HRESETN_SRAM4_CLEAR      (1<<5)
#define CPU_SYS_CTRL_HRESETN_SRAM4_CLEAR_POS  (5)
#define CPU_SYS_CTRL_HRESETN_SRAM5_CLEAR      (1<<6)
#define CPU_SYS_CTRL_HRESETN_SRAM5_CLEAR_POS  (6)
#define CPU_SYS_CTRL_HRESETN_SRAM6_CLEAR      (1<<7)
#define CPU_SYS_CTRL_HRESETN_SRAM6_CLEAR_POS  (7)
...
#define CPU_SYS_CTRL_HRESETN_PCIE_CLEAR      (1<<19)
#define CPU_SYS_CTRL_HRESETN_PCIE_CLEAR_POS  (19)
#define CPU_SYS_CTRL_HRESETN_AUD_PROC_CLEAR      (1<<20)
#define CPU_SYS_CTRL_HRESETN_AUD_PROC_CLEAR_POS  (20)
#define CPU_SYS_CTRL_HRESETN_MAILBOX_CLEAR      (1<<21)
#define CPU_SYS_CTRL_HRESETN_MAILBOX_CLEAR_POS  (21)
#define CPU_SYS_CTRL_HRESETN_SDIO_CLEAR      (1<<22)
#define CPU_SYS_CTRL_HRESETN_SDIO_CLEAR_POS  (22)
#define CPU_SYS_CTRL_HRESETN_MM_SYS_CLEAR      (1<<23)
#define CPU_SYS_CTRL_HRESETN_MM_SYS_CLEAR_POS  (23)
#define CPU_SYS_CTRL_HRESETN_SDMMC_CLEAR      (1<<24)
#define CPU_SYS_CTRL_HRESETN_SDMMC_CLEAR_POS  (24)
...
#define CPU_SYS_CTRL_RESETN_1M_PCIE_SET      (1<<15)
#define CPU_SYS_CTRL_RESETN_1M_PCIE_SET_POS  (15)
#define CPU_SYS_CTRL_RESETN_USBC_SET      (1<<16)
#define CPU_SYS_CTRL_RESETN_USBC_SET_POS  (16)
...
#define CPU_SYS_CTRL_RESETN_1M_PCIE_CLEAR      (1<<15)
#define CPU_SYS_CTRL_RESETN_1M_PCIE_CLEAR_POS  (15)
#define CPU_SYS_CTRL_RESETN_USBC_CLEAR      (1<<16)
#define CPU_SYS_CTRL_RESETN_USBC_CLEAR_POS  (16)
...
typedef struct {
  ...
  __IO uint32_t                          host_dma_cfg;                 //0x0000005C
...
#define MM_SYS_CTRL_RG_HOST_DMA_TPORTS_SEL(n)      (((n)&15)<<2)
#define MM_SYS_CTRL_RG_HOST_DMA_TPORTS_SEL_LSB     (2)
#define MM_SYS_CTRL_RG_HOST_DMA_TPORTS_SEL_MASK    (15<<2)
...
#define MM_SYS_CTRL_RG_BBPLL_CLK_USB_EN_DR      (1<<30)
#define MM_SYS_CTRL_RG_BBPLL_CLK_USB_EN_DR_POS  (30)
#define MM_SYS_CTRL_RG_BBPLL_CLK_USB_EN      (1<<31)
#define MM_SYS_CTRL_RG_BBPLL_CLK_USB_EN_POS  (31)
...
#define MM_SYS_CTRL_RG_USB_DLL_CLK_SEL_BBPLL_PCIE      (1<<8)
#define MM_SYS_CTRL_RG_USB_DLL_CLK_SEL_BBPLL_PCIE_POS  (8)
...
//host_dma_cfg
#define MM_SYS_CTRL_RG_HOST_DMA_UPSTREAM_HBURST(n)      (((n)&7)<<0)
#define MM_SYS_CTRL_RG_HOST_DMA_UPSTREAM_HBURST_LSB     (0)
#define MM_SYS_CTRL_RG_HOST_DMA_UPSTREAM_HBURST_MASK    (7<<0)
#define MM_SYS_CTRL_RG_HOST_DMA_DOWNSTREAM_HBURST(n)      (((n)&7)<<4)
#define MM_SYS_CTRL_RG_HOST_DMA_DOWNSTREAM_HBURST_LSB     (4)
#define MM_SYS_CTRL_RG_HOST_DMA_DOWNSTREAM_HBURST_MASK    (7<<4)
...
typedef struct {
  ...
  __IO uint32_t                          cpu_s1_reset_addr;            //0x0000004C
  __IO uint32_t                          cfg_cpu_sys_ctrl;             //0x00000050
  __IO uint32_t                          cfg_rtc1_pu_dcdc_resetn_bypass; //0x00000054
  __IO uint32_t                          cfg_sdio_iomux_sel;           //0x00000058
  __IO uint32_t                          cfg_mem_cpu_sys_1pram;        //0x0000005C
  __IO uint32_t                          cfg_mem_bt_sys_1pram;         //0x00000060
  __IO uint32_t                          bt_hclk_div;                  //0x00000064
  __IO uint32_t                          top_tports_bits_sel0;         //0x00000068
  __IO uint32_t                          top_tports_bits_sel1;         //0x0000006C
  __IO uint32_t                          top_tports_bits_sel2;         //0x00000070
  __IO uint32_t                          top_tports_bits_sel3;         //0x00000074
  __IO uint32_t                          perst_cfg;                    //0x00000078
  __IO uint32_t                          pcm_clk_div;                  //0x0000007C
  __IO uint32_t Reserved_00000080[32];                //0x00000080
  __IO uint32_t                          hclk_manual_enable;           //0x00000100
  __IO uint32_t                          hclk_manual_disable;          //0x00000104
...
#define SYS_CTRL_CFG_AON_CLK_80M_HWEN      (1<<1)
#define SYS_CTRL_CFG_AON_CLK_80M_HWEN_POS  (1)
#define SYS_CTRL_CFG_AON_CLK_80M_SEL      (1<<2)
#define SYS_CTRL_CFG_AON_CLK_80M_SEL_POS  (2)
...
#define SYS_CTRL_BT_WDG_RST_HAPPENED      (1<<3)
#define SYS_CTRL_BT_WDG_RST_HAPPENED_POS  (3)
#define SYS_CTRL_CPU_P_SYSRST_REQ_HAPPENED      (1<<4)
#define SYS_CTRL_CPU_P_SYSRST_REQ_HAPPENED_POS  (4)
#define SYS_CTRL_CPU_S0_SYSRST_REQ_HAPPENED      (1<<5)
#define SYS_CTRL_CPU_S0_SYSRST_REQ_HAPPENED_POS  (5)
#define SYS_CTRL_CPU_S1_SYSRST_REQ_HAPPENED      (1<<6)
#define SYS_CTRL_CPU_S1_SYSRST_REQ_HAPPENED_POS  (6)
#define SYS_CTRL_GLOBAL_SOFT_RESET_HAPPENED      (1<<7)
#define SYS_CTRL_GLOBAL_SOFT_RESET_HAPPENED_POS  (7)
#define SYS_CTRL_PERST_HAPPENED         (1<<8)
#define SYS_CTRL_PERST_HAPPENED_POS     (8)
...
#define SYS_CTRL_CFG_RTC1_PU_DCDC_RESETN_BYPASS      (1<<0)
#define SYS_CTRL_CFG_RTC1_PU_DCDC_RESETN_BYPASS_POS  (0)
...
//cfg_mem_bt_sys_1pram
#define SYS_CTRL_CFG_MEM_BT_SYS_1PRAM(n)      (((n)&0xFFFF)<<0)
#define SYS_CTRL_CFG_MEM_BT_SYS_1PRAM_LSB     (0)
#define SYS_CTRL_CFG_MEM_BT_SYS_1PRAM_MASK    (0xFFFF<<0)
...
//perst_cfg
#define SYS_CTRL_PERST_ACT_DLY(n)       (((n)&0xFF)<<0)
#define SYS_CTRL_PERST_ACT_DLY_LSB      (0)
#define SYS_CTRL_PERST_ACT_DLY_MASK     (0xFF<<0)
#define SYS_CTRL_PERST_INACT_DLY(n)      (((n)&0xFF)<<8)
#define SYS_CTRL_PERST_INACT_DLY_LSB     (8)
#define SYS_CTRL_PERST_INACT_DLY_MASK    (0xFF<<8)
#define SYS_CTRL_PERST_GLOBAL_REQ_EN      (1<<16)
#define SYS_CTRL_PERST_GLOBAL_REQ_EN_POS  (16)
#define SYS_CTRL_PCIE_WAKE_SEL(n)       (((n)&3)<<17)
#define SYS_CTRL_PCIE_WAKE_SEL_LSB      (17)
#define SYS_CTRL_PCIE_WAKE_SEL_MASK     (3<<17)

//pcm_clk_div
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_DENOM(n)      (((n)&0xFFF)<<0)
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_DENOM_LSB     (0)
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_DENOM_MASK    (0xFFF<<0)
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_NUM(n)      (((n)&0xFFF)<<12)
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_NUM_LSB     (12)
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_NUM_MASK    (0xFFF<<12)
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_UPDATE      (1<<24)
#define SYS_CTRL_CFG_TOP_PCM_CLK_DIV_UPDATE_POS  (24)
#define SYS_CTRL_CFG_TOP_PCM_CLK_SEL      (1<<25)
#define SYS_CTRL_CFG_TOP_PCM_CLK_SEL_POS  (25)
...
#define SYS_CTRL_HCLK_TOP_VCORE_DISABLE      (1<<4)
#define SYS_CTRL_HCLK_TOP_VCORE_DISABLE_POS  (4)
...
#define SYS_CTRL_CLK_MEM_2X_MANUAL_ENABLE      (1<<9)
#define SYS_CTRL_CLK_MEM_2X_MANUAL_ENABLE_POS  (9)
#define SYS_CTRL_CLK_PLL_DIV_80M_MANUAL_ENABLE      (1<<10)
#define SYS_CTRL_CLK_PLL_DIV_80M_MANUAL_ENABLE_POS  (10)
...
#define SYS_CTRL_CLK_MEM_2X_MANUAL_DISABLE      (1<<9)
#define SYS_CTRL_CLK_MEM_2X_MANUAL_DISABLE_POS  (9)
#define SYS_CTRL_CLK_PLL_DIV_80M_MANUAL_DISABLE      (1<<10)
#define SYS_CTRL_CLK_PLL_DIV_80M_MANUAL_DISABLE_POS  (10)
...
#define SYS_CTRL_HCLK_WCN_AON_MANUAL_ENABLE      (1<<9)
#define SYS_CTRL_HCLK_WCN_AON_MANUAL_ENABLE_POS  (9)
#define SYS_CTRL_HCLK_PSI_SLV_MANUAL_ENABLE      (1<<10)
#define SYS_CTRL_HCLK_PSI_SLV_MANUAL_ENABLE_POS  (10)
#define SYS_CTRL_PCLK_SYS_CTRL_MANUAL_ENABLE      (1<<11)
#define SYS_CTRL_PCLK_SYS_CTRL_MANUAL_ENABLE_POS  (11)
#define SYS_CTRL_PCLK_TIMER2_MANUAL_ENABLE      (1<<12)
#define SYS_CTRL_PCLK_TIMER2_MANUAL_ENABLE_POS  (12)
#define SYS_CTRL_PCLK_ANALOG_REG1_MANUAL_ENABLE      (1<<13)
#define SYS_CTRL_PCLK_ANALOG_REG1_MANUAL_ENABLE_POS  (13)
#define SYS_CTRL_PCLK_IOMUX_MANUAL_ENABLE      (1<<14)
#define SYS_CTRL_PCLK_IOMUX_MANUAL_ENABLE_POS  (14)
#define SYS_CTRL_PCLK_GPIOB_MANUAL_ENABLE      (1<<15)
#define SYS_CTRL_PCLK_GPIOB_MANUAL_ENABLE_POS  (15)
#define SYS_CTRL_PCLK_PWR_CTRL_MANUAL_ENABLE      (1<<16)
#define SYS_CTRL_PCLK_PWR_CTRL_MANUAL_ENABLE_POS  (16)
#define SYS_CTRL_PCLK_AON_PWM_MANUAL_ENABLE      (1<<17)
#define SYS_CTRL_PCLK_AON_PWM_MANUAL_ENABLE_POS  (17)
#define SYS_CTRL_PCLK_WDG2_MANUAL_ENABLE      (1<<18)
#define SYS_CTRL_PCLK_WDG2_MANUAL_ENABLE_POS  (18)
#define SYS_CTRL_PCLK_CM_RF_INTF_MANUAL_ENABLE      (1<<19)
#define SYS_CTRL_PCLK_CM_RF_INTF_MANUAL_ENABLE_POS  (19)
#define SYS_CTRL_PCLK_PSI_MST_MANUAL_ENABLE      (1<<20)
#define SYS_CTRL_PCLK_PSI_MST_MANUAL_ENABLE_POS  (20)
#define SYS_CTRL_PCLK_AON_SYS_CTRL_MANUAL_ENABLE      (1<<21)
#define SYS_CTRL_PCLK_AON_SYS_CTRL_MANUAL_ENABLE_POS  (21)
...
#define SYS_CTRL_HCLK_WCN_AON_MANUAL_DISABLE      (1<<9)
#define SYS_CTRL_HCLK_WCN_AON_MANUAL_DISABLE_POS  (9)
#define SYS_CTRL_HCLK_PSI_SLV_MANUAL_DISABLE      (1<<10)
#define SYS_CTRL_HCLK_PSI_SLV_MANUAL_DISABLE_POS  (10)
#define SYS_CTRL_PCLK_SYS_CTRL_MANUAL_DISABLE      (1<<11)
#define SYS_CTRL_PCLK_SYS_CTRL_MANUAL_DISABLE_POS  (11)
#define SYS_CTRL_PCLK_TIMER2_MANUAL_DISABLE      (1<<12)
#define SYS_CTRL_PCLK_TIMER2_MANUAL_DISABLE_POS  (12)
#define SYS_CTRL_PCLK_ANALOG_REG1_MANUAL_DISABLE      (1<<13)
#define SYS_CTRL_PCLK_ANALOG_REG1_MANUAL_DISABLE_POS  (13)
#define SYS_CTRL_PCLK_IOMUX_MANUAL_DISABLE      (1<<14)
#define SYS_CTRL_PCLK_IOMUX_MANUAL_DISABLE_POS  (14)
#define SYS_CTRL_PCLK_GPIOB_MANUAL_DISABLE      (1<<15)
#define SYS_CTRL_PCLK_GPIOB_MANUAL_DISABLE_POS  (15)
#define SYS_CTRL_PCLK_PWR_CTRL_MANUAL_DISABLE      (1<<16)
#define SYS_CTRL_PCLK_PWR_CTRL_MANUAL_DISABLE_POS  (16)
#define SYS_CTRL_PCLK_AON_PWM_MANUAL_DISABLE      (1<<17)
#define SYS_CTRL_PCLK_AON_PWM_MANUAL_DISABLE_POS  (17)
#define SYS_CTRL_PCLK_WDG2_MANUAL_DISABLE      (1<<18)
#define SYS_CTRL_PCLK_WDG2_MANUAL_DISABLE_POS  (18)
#define SYS_CTRL_PCLK_CM_RF_INTF_MANUAL_DISABLE      (1<<19)
#define SYS_CTRL_PCLK_CM_RF_INTF_MANUAL_DISABLE_POS  (19)
#define SYS_CTRL_PCLK_PSI_MST_MANUAL_DISABLE      (1<<20)
#define SYS_CTRL_PCLK_PSI_MST_MANUAL_DISABLE_POS  (20)
#define SYS_CTRL_PCLK_AON_SYS_CTRL_MANUAL_DISABLE      (1<<21)
#define SYS_CTRL_PCLK_AON_SYS_CTRL_MANUAL_DISABLE_POS  (21)
...
#define SYS_CTRL_HRESETN_VCORE_TOP_SET      (1<<4)
#define SYS_CTRL_HRESETN_VCORE_TOP_SET_POS  (4)
...
#define SYS_CTRL_HRESETN_VCORE_TOP_CLEAR      (1<<4)
#define SYS_CTRL_HRESETN_VCORE_TOP_CLEAR_POS  (4)
...
#define SYS_CTRL_RESETN_WIFI_SYS_SET      (1<<14)
#define SYS_CTRL_RESETN_WIFI_SYS_SET_POS  (14)
#define SYS_CTRL_RESETN_BT_SYS_SET      (1<<15)
#define SYS_CTRL_RESETN_BT_SYS_SET_POS  (15)
...
#define SYS_CTRL_RESETN_WIFI_SYS_CLEAR      (1<<14)
#define SYS_CTRL_RESETN_WIFI_SYS_CLEAR_POS  (14)
#define SYS_CTRL_RESETN_BT_SYS_CLEAR      (1<<15)
#define SYS_CTRL_RESETN_BT_SYS_CLEAR_POS  (15)
...
#define SYS_CTRL_RESETN_PSI_SLV_SET      (1<<8)
#define SYS_CTRL_RESETN_PSI_SLV_SET_POS  (8)
#define SYS_CTRL_RESETN_AON_PWM_SET      (1<<9)
#define SYS_CTRL_RESETN_AON_PWM_SET_POS  (9)
#define SYS_CTRL_RESETN_PWR_CTRL_SET      (1<<10)
#define SYS_CTRL_RESETN_PWR_CTRL_SET_POS  (10)
#define SYS_CTRL_HRESETN_PMU_PSI_SLV_SET      (1<<11)
#define SYS_CTRL_HRESETN_PMU_PSI_SLV_SET_POS  (11)
#define SYS_CTRL_HRESETN_AON_MATRIX_SET      (1<<12)
#define SYS_CTRL_HRESETN_AON_MATRIX_SET_POS  (12)
#define SYS_CTRL_HRESETN_CM0P_SET       (1<<13)
#define SYS_CTRL_HRESETN_CM0P_SET_POS   (13)
#define SYS_CTRL_HRESETN_AON_SRAM_SET      (1<<14)
#define SYS_CTRL_HRESETN_AON_SRAM_SET_POS  (14)
#define SYS_CTRL_HRESETN_WCN_AON_SET      (1<<15)
#define SYS_CTRL_HRESETN_WCN_AON_SET_POS  (15)
#define SYS_CTRL_HRESETN_PSI_SLV_SET      (1<<16)
#define SYS_CTRL_HRESETN_PSI_SLV_SET_POS  (16)
#define SYS_CTRL_PRESETN_SYS_CTRL_SET      (1<<17)
#define SYS_CTRL_PRESETN_SYS_CTRL_SET_POS  (17)
#define SYS_CTRL_PRESETN_TIMER2_SET      (1<<18)
#define SYS_CTRL_PRESETN_TIMER2_SET_POS  (18)
#define SYS_CTRL_PRESETN_ANALOG_REG1_SET      (1<<19)
#define SYS_CTRL_PRESETN_ANALOG_REG1_SET_POS  (19)
#define SYS_CTRL_PRESETN_IOMUX_SET      (1<<20)
#define SYS_CTRL_PRESETN_IOMUX_SET_POS  (20)
#define SYS_CTRL_PRESETN_GPIOB_SET      (1<<21)
#define SYS_CTRL_PRESETN_GPIOB_SET_POS  (21)
#define SYS_CTRL_PRESETN_PWR_CTRL_SET      (1<<22)
#define SYS_CTRL_PRESETN_PWR_CTRL_SET_POS  (22)
#define SYS_CTRL_PRESETN_AON_PWM_SET      (1<<23)
#define SYS_CTRL_PRESETN_AON_PWM_SET_POS  (23)
#define SYS_CTRL_PRESETN_WDG2_SET       (1<<24)
#define SYS_CTRL_PRESETN_WDG2_SET_POS   (24)
#define SYS_CTRL_PRESETN_CM_RF_INTF_SET      (1<<25)
#define SYS_CTRL_PRESETN_CM_RF_INTF_SET_POS  (25)
#define SYS_CTRL_PRESETN_PSI_MST_SET      (1<<26)
#define SYS_CTRL_PRESETN_PSI_MST_SET_POS  (26)
#define SYS_CTRL_PRESETN_AON_SYS_CTRL_SET      (1<<27)
#define SYS_CTRL_PRESETN_AON_SYS_CTRL_SET_POS  (27)
...
#define SYS_CTRL_RESETN_PSI_SLV_CLEAR      (1<<8)
#define SYS_CTRL_RESETN_PSI_SLV_CLEAR_POS  (8)
#define SYS_CTRL_RESETN_AON_PWM_CLEAR      (1<<9)
#define SYS_CTRL_RESETN_AON_PWM_CLEAR_POS  (9)
#define SYS_CTRL_RESETN_PWR_CTRL_CLEAR      (1<<10)
#define SYS_CTRL_RESETN_PWR_CTRL_CLEAR_POS  (10)
#define SYS_CTRL_RESETN_PMU_PSI_SLV_CLEAR      (1<<11)
#define SYS_CTRL_RESETN_PMU_PSI_SLV_CLEAR_POS  (11)
#define SYS_CTRL_HRESETN_AON_MATRIX_CLEAR      (1<<12)
#define SYS_CTRL_HRESETN_AON_MATRIX_CLEAR_POS  (12)
#define SYS_CTRL_HRESETN_CM0P_CLEAR      (1<<13)
#define SYS_CTRL_HRESETN_CM0P_CLEAR_POS  (13)
#define SYS_CTRL_HRESETN_AON_SRAM_CLEAR      (1<<14)
#define SYS_CTRL_HRESETN_AON_SRAM_CLEAR_POS  (14)
#define SYS_CTRL_HRESETN_WCN_AON_CLEAR      (1<<15)
#define SYS_CTRL_HRESETN_WCN_AON_CLEAR_POS  (15)
#define SYS_CTRL_HRESETN_PSI_SLV_CLEAR      (1<<16)
#define SYS_CTRL_HRESETN_PSI_SLV_CLEAR_POS  (16)
#define SYS_CTRL_PRESETN_SYS_CTRL_CLEAR      (1<<17)
#define SYS_CTRL_PRESETN_SYS_CTRL_CLEAR_POS  (17)
#define SYS_CTRL_PRESETN_TIMER2_CLEAR      (1<<18)
#define SYS_CTRL_PRESETN_TIMER2_CLEAR_POS  (18)
#define SYS_CTRL_PRESETN_ANALOG_REG1_CLEAR      (1<<19)
#define SYS_CTRL_PRESETN_ANALOG_REG1_CLEAR_POS  (19)
#define SYS_CTRL_PRESETN_IOMUX_CLEAR      (1<<20)
#define SYS_CTRL_PRESETN_IOMUX_CLEAR_POS  (20)
#define SYS_CTRL_PRESETN_GPIOB_CLEAR      (1<<21)
#define SYS_CTRL_PRESETN_GPIOB_CLEAR_POS  (21)
#define SYS_CTRL_PRESETN_PWR_CTRL_CLEAR      (1<<22)
#define SYS_CTRL_PRESETN_PWR_CTRL_CLEAR_POS  (22)
#define SYS_CTRL_PRESETN_AON_PWM_CLEAR      (1<<23)
#define SYS_CTRL_PRESETN_AON_PWM_CLEAR_POS  (23)
#define SYS_CTRL_PRESETN_WDG2_CLEAR      (1<<24)
#define SYS_CTRL_PRESETN_WDG2_CLEAR_POS  (24)
#define SYS_CTRL_PRESETN_CM_RF_INTF_CLEAR      (1<<25)
#define SYS_CTRL_PRESETN_CM_RF_INTF_CLEAR_POS  (25)
#define SYS_CTRL_PRESETN_PSI_MST_CLEAR      (1<<26)
#define SYS_CTRL_PRESETN_PSI_MST_CLEAR_POS  (26)
#define SYS_CTRL_PRESETN_AON_SYS_CTRL_CLEAR      (1<<27)
#define SYS_CTRL_PRESETN_AON_SYS_CTRL_CLEAR_POS  (27)
...
#define SYS_CTRL_BT_WDG_RST_EN          (1<<3)
#define SYS_CTRL_BT_WDG_RST_EN_POS      (3)
#define SYS_CTRL_CPU_P_SYSRST_EN        (1<<4)
#define SYS_CTRL_CPU_P_SYSRST_EN_POS    (4)
#define SYS_CTRL_CPU_S0_SYSRST_EN       (1<<5)
#define SYS_CTRL_CPU_S0_SYSRST_EN_POS   (5)
#define SYS_CTRL_CPU_S1_SYSRST_EN       (1<<6)
#define SYS_CTRL_CPU_S1_SYSRST_EN_POS   (6)
#define SYS_CTRL_PERST_RST_EN           (1<<8)
#define SYS_CTRL_PERST_RST_EN_POS       (8)
...
//sw defined fields
#define BTFW_CTRL_ADID_INIT_STATUS          (0)
#define BTFW_CTRL_ADID_INIT_STATUS_WIDTH    (8)
#define BTFW_CTRL_ADID_INIT_STATUS_MASK     (0x000000FF)
...
typedef struct {
  ...
  __IO uint32_t Reserved_00000058;                    //0x00000058
  ...
  __IO uint32_t                          pwr_ctrl_soft_mode4;          //0x0000006C
  __IO uint32_t                          pwr_off_timmer_th3;           //0x00000070
  __IO uint32_t                          pwr_off_timmer_th4;           //0x00000074
  __IO uint32_t                          bt_core_timer_cnt_ro;         //0x00000078
  __IO uint32_t                          wifi_core_timer_cnt_ro;       //0x0000007C
} AIC_PWRCTRL_TypeDef;
...
#define PWR_CTRL_WLAN_CORE_TIMER_POFF_PWR_SYS_SEL      (1<<27)
#define PWR_CTRL_WLAN_CORE_TIMER_POFF_PWR_SYS_SEL_POS  (27)
...
//pwr_off_timmer_th1
#define PWR_CTRL_BT_CORE_TIMER_TH(n)      (((n)&0xFFFFFFFF)<<0)
#define PWR_CTRL_BT_CORE_TIMER_TH_LSB     (0)
#define PWR_CTRL_BT_CORE_TIMER_TH_MASK    (0xFFFFFFFF<<0)

//pwr_off_timmer_th2
#define PWR_CTRL_WIFI_CORE_TIMER_TH(n)      (((n)&0xFFFFFFFF)<<0)
#define PWR_CTRL_WIFI_CORE_TIMER_TH_LSB     (0)
#define PWR_CTRL_WIFI_CORE_TIMER_TH_MASK    (0xFFFFFFFF<<0)
...
#define PWR_CTRL_CFG_RG_IRQ_OTHERS_AWAKE_EN(n)      (((n)&15)<<27)
#define PWR_CTRL_CFG_RG_IRQ_OTHERS_AWAKE_EN_LSB     (27)
#define PWR_CTRL_CFG_RG_IRQ_OTHERS_AWAKE_EN_MASK    (15<<27)

//pwr_ctrl_soft_mode4
#define PWR_CTRL_CFG_AWAKE_INV_EN(n)      (((n)&0x3FF)<<0)
#define PWR_CTRL_CFG_AWAKE_INV_EN_LSB     (0)
#define PWR_CTRL_CFG_AWAKE_INV_EN_MASK    (0x3FF<<0)

//pwr_off_timmer_th3
#define PWR_CTRL_CPU_SYS_TIMER_TH(n)      (((n)&0xFFFFFFFF)<<0)
#define PWR_CTRL_CPU_SYS_TIMER_TH_LSB     (0)
#define PWR_CTRL_CPU_SYS_TIMER_TH_MASK    (0xFFFFFFFF<<0)

//pwr_off_timmer_th4
#define PWR_CTRL_VCORE_SYS_TIMER_TH(n)      (((n)&0xFFFFFFFF)<<0)
#define PWR_CTRL_VCORE_SYS_TIMER_TH_LSB     (0)
#define PWR_CTRL_VCORE_SYS_TIMER_TH_MASK    (0xFFFFFFFF<<0)

//bt_core_timer_cnt_ro
#define PWR_CTRL_BT_CORE_TIMER_CNT_RO(n)      (((n)&0xFFFFFFFF)<<0)
#define PWR_CTRL_BT_CORE_TIMER_CNT_RO_LSB     (0)
#define PWR_CTRL_BT_CORE_TIMER_CNT_RO_MASK    (0xFFFFFFFF<<0)

//wifi_core_timer_cnt_ro
#define PWR_CTRL_WIFI_CORE_TIMER_CNT_RO(n)      (((n)&0xFFFFFFFF)<<0)
#define PWR_CTRL_WIFI_CORE_TIMER_CNT_RO_LSB     (0)
#define PWR_CTRL_WIFI_CORE_TIMER_CNT_RO_MASK    (0xFFFFFFFF<<0)
...
__STATIC_INLINE uint8_t aonsysctrl_rstcause_btwdt_rst_getb(void)
{
    return (AIC_AONSYSCTRL->reset_cause & SYS_CTRL_BT_WDG_RST_HAPPENED) >> SYS_CTRL_BT_WDG_RST_HAPPENED_POS;
}
...
__STATIC_INLINE uint8_t aonsysctrl_rstcause_perst_getb(void)
{
    return (AIC_AONSYSCTRL->reset_cause & SYS_CTRL_PERST_HAPPENED) >> SYS_CTRL_PERST_HAPPENED_POS;
}
...
__STATIC_INLINE uint8_t aonsysctrl_wdtre_btwdt_rst_en_getb(void)
{
    return (AIC_AONSYSCTRL->wdg_reset_en & SYS_CTRL_BT_WDG_RST_EN) >> SYS_CTRL_BT_WDG_RST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_btwdt_rst_en_setb(void)
{
    AIC_AONSYSCTRL->wdg_reset_en |=  SYS_CTRL_BT_WDG_RST_EN;
}

__STATIC_INLINE void aonsysctrl_wdtre_btwdt_rst_en_clrb(void)
{
    AIC_AONSYSCTRL->wdg_reset_en &= ~SYS_CTRL_BT_WDG_RST_EN;
}
...
__STATIC_INLINE uint8_t aonsysctrl_wdtre_perst_rst_en_getb(void)
{
    return (AIC_AONSYSCTRL->wdg_reset_en & SYS_CTRL_PERST_RST_EN) >> SYS_CTRL_PERST_RST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_perst_rst_en_setb(void)
{
    AIC_AONSYSCTRL->wdg_reset_en |=  SYS_CTRL_PERST_RST_EN;
}

__STATIC_INLINE void aonsysctrl_wdtre_perst_rst_en_clrb(void)
{
    AIC_AONSYSCTRL->wdg_reset_en &= ~SYS_CTRL_PERST_RST_EN;
}
...
__STATIC_INLINE uint8_t aonsysctrl_btfwctrl_adid_status_getf(void)
{
    return (AIC_AONSYSCTRL->BTFWCTRL & BTFW_CTRL_ADID_INIT_STATUS_MASK);
}

__STATIC_INLINE void aonsysctrl_btfwctrl_adid_status_setf(uint8_t status)
{
    AIC_AONSYSCTRL->BTFWCTRL = (AIC_AONSYSCTRL->reserved_reg0 & (~BTFW_CTRL_ADID_INIT_STATUS_MASK)) | status;
}
...
__STATIC_INLINE uint8_t pwrctrl_softmd3_other_awake_en_getf(void)
{
    return ((AIC_PWRCTRL->pwr_ctrl_soft_mode3 & PWR_CTRL_CFG_RG_IRQ_OTHERS_AWAKE_EN_MASK) >> PWR_CTRL_CFG_RG_IRQ_OTHERS_AWAKE_EN_LSB);
}

__STATIC_INLINE void pwrctrl_softmd3_other_awake_en_setf(uint8_t en)
{
    uint32_t local_val = AIC_PWRCTRL->pwr_ctrl_soft_mode3 & ~PWR_CTRL_CFG_RG_IRQ_OTHERS_AWAKE_EN_MASK;
    AIC_PWRCTRL->pwr_ctrl_soft_mode3 = local_val | PWR_CTRL_CFG_RG_IRQ_OTHERS_AWAKE_EN(en);
}
