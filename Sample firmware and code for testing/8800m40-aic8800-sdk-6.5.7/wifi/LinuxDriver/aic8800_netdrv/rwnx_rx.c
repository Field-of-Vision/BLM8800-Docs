    ...
    switch(msg->id) {
        ...
        case CUST_CMD_GET_VNET_SETTING_CFM:
            ...
            printk("<vnet-mode>\n"
                   ...
                   " - filter_mode:  %d\n"
                   " - upgrade_addr: %08x\n",
                   g_custom_msg_vnet.vnet_setting_cfm.keep_alive,
                   g_custom_msg_vnet.vnet_setting_cfm.ble_enable, g_custom_msg_vnet.vnet_setting_cfm.lzma_enable,
                   g_custom_msg_vnet.vnet_setting_cfm.filter_mode, g_custom_msg_vnet.vnet_setting_cfm.upgrade_addr);
