...
python ../../../tools/scons.py -u . PRODUCT=basic-rtos PLF=aic8800mc BT=armgcc_4_8 BUILD_CMD="$0 $*" TGT_MODE=test TEST=flash TGTNAME=host_wb_test_flash CODE_START_ADDR=0x110000 $opt
