...
#define UART2_TOIRQEN_BIT  ((uint32_t)0x00000020)
#define UART2_TOIRQEN_POS  5
...
#define UART2_TOIRQEN_RST  0x0
#define UART2_MSIRQEN_RST  0x0
#define UART2_LSIRQEN_RST  0x0
#define UART2_TXIRQEN_RST  0x0
#define UART2_RXIRQEN_RST  0x0

__INLINE void uart2_irqctl_pack(uint8_t ptirqen, uint8_t toirqen, uint8_t msirqen, uint8_t lsirqen, uint8_t txirqen, uint8_t rxirqen)
{
    REG_PL_WR(UART2_IRQCTL_ADDR,  ((uint32_t)ptirqen << 7) | ((uint32_t)toirqen << 5) | ((uint32_t)msirqen << 3) | ((uint32_t)lsirqen << 2) | ((uint32_t)txirqen << 1) | ((uint32_t)rxirqen << 0));
}

__INLINE void uart2_irqctl_unpack(uint8_t* ptirqen, uint8_t *toirqen, uint8_t* msirqen, uint8_t* lsirqen, uint8_t* txirqen, uint8_t* rxirqen)
{
...
__INLINE uint8_t uart2_toirqen_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_IRQCTL_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__INLINE void uart2_toirqen_setf(uint8_t toirqen)
{
    REG_PL_WR(UART2_IRQCTL_ADDR, (REG_PL_RD(UART2_IRQCTL_ADDR) & ~((uint32_t)0x00000020)) | ((uint32_t)toirqen << 5));
}
...
// field definitions
#define UART2_DMAMOD_BIT   ((uint32_t)0x00000008)
#define UART2_DMAMOD_POS   3
...
#define UART2_DMAMOD_RST   0x0
#define UART2_TXDRST_RST   0x0
#define UART2_RXDRST_RST   0x0
#define UART2_DBUFEN_RST   0x0

__INLINE void uart2_dbufcfg_pack(uint8_t dmamod, uint8_t txdrst, uint8_t rxdrst, uint8_t dbufen)
{
    REG_PL_WR(UART2_DBUFCFG_ADDR, ((uint32_t)dmamod << 3) | ((uint32_t)txdrst << 2) | ((uint32_t)rxdrst << 1) | ((uint32_t)dbufen << 0));
}

__INLINE void uart2_dmamod_setf(uint8_t dmamod)
{
    REG_PL_WR(UART2_DBUFCFG_ADDR, (REG_PL_RD(UART2_DBUFCFG_ADDR) & ~((uint32_t)0x00000008)) | ((uint32_t)dmamod << 3));
}
...
// field definitions
#define UART2_RXTOTRIGEN_BIT   ((uint32_t)0x00040000)
#define UART2_RXTOTRIGEN_POS   18
...
#define UART2_RXTOTRIGEN_RST   0x0
#define UART2_TXTRIGTH_RST     0x10
#define UART2_RXTRIGTH_RST     0x10

__INLINE void uart2_dbufth_pack(uint8_t rxtotrigen, uint8_t txtrigth, uint8_t rxtrigth)
{
    REG_PL_WR(UART2_DBUFTH_ADDR,  ((uint32_t)rxtotrigen << 18) | ((uint32_t)txtrigth << 9) | ((uint32_t)rxtrigth << 0));
}

__INLINE void uart2_dbufth_unpack(uint8_t *rxtotrigen, uint8_t* txtrigth, uint8_t* rxtrigth)
{
...
__INLINE uint8_t uart2_rxtotrigen_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_DBUFTH_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}

__INLINE void uart2_rxtotrigen_setf(uint8_t txtrigth)
{
    REG_PL_WR(UART2_DBUFTH_ADDR, (REG_PL_RD(UART2_DBUFTH_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)txtrigth << 18));
}
