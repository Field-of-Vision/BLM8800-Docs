...
#define PMU_RTC0_RTC_RG_PMU_MS_VIO_RTC0      (1<<15)
#define PMU_RTC0_RTC_RG_PMU_MS_VIO_RTC0_POS  (15)
#define PMU_RTC0_RTC_RG_PMU_MS_LDO33_RTC0      (1<<16)
#define PMU_RTC0_RTC_RG_PMU_MS_LDO33_RTC0_POS  (16)
#define PMU_RTC0_RTC_RG_PMU_MS_AVDD33USB_RTC0      (1<<17)
#define PMU_RTC0_RTC_RG_PMU_MS_AVDD33USB_RTC0_POS  (17)
#define PMU_RTC0_RTC_RG_RTC_GPIO_CLR      (1<<18)
#define PMU_RTC0_RTC_RG_RTC_GPIO_CLR_POS  (18)
#define PMU_RTC0_RTC_RG_PB_INT_DEBC_CLR      (1<<19)
#define PMU_RTC0_RTC_RG_PB_INT_DEBC_CLR_POS  (19)
#define PMU_RTC0_RTC_RG_PMU_SOFT_RSTN      (1<<31)
#define PMU_RTC0_RTC_RG_PMU_SOFT_RSTN_POS  (31)
...
#define PMU_RTC0_RTC_RG_AGPIO_HOLD      (1<<30)
#define PMU_RTC0_RTC_RG_AGPIO_HOLD_POS  (30)
#define PMU_RTC0_RTC_RG_FLS_HOLD        (1<<31)
#define PMU_RTC0_RTC_RG_FLS_HOLD_POS    (31)
