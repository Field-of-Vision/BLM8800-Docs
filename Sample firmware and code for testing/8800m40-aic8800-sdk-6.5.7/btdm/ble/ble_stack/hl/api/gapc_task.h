...
enum gapc_appearance{
    GAPC_APPEARANCE_UNKNOWN                             = 0,
    GAPC_APPEARANCE_GENERIC_PHONE                       = 64,
    GAPC_APPEARANCE_GENERIC_COMPUTER                    = 128,
    GAPC_APPEARANCE_GENERIC_WATCH                       = 192,
    GAPC_APPEARANCE_WATCH_SPORTS_WATCH                  = 193,
    GAPC_APPEARANCE_GENERIC_CLOCK                       = 256,
    GAPC_APPEARANCE_GENERIC_DISPLAY                     = 320,
    GAPC_APPEARANCE_GENERIC_REMOTE_CONTROL              = 384,
    GAPC_APPEARANCE_GENERIC_EYE_GLASSES                 = 448,
    GAPC_APPEARANCE_GENERIC_TAG                         = 512,
    GAPC_APPEARANCE_GENERIC_KEYRING                     = 576,
    GAPC_APPEARANCE_GENERIC_MEDIA_PLAYER                = 640,
    GAPC_APPEARANCE_GENERIC_BARCODE_SCANNER             = 704,
    GAPC_APPEARANCE_GENERIC_THERMOMETER                 = 768,
    GAPC_APPEARANCE_THERMOMETER_EAR                     = 769,
    GAPC_APPEARANCE_GENERIC_HEART_RATE_SENSOR           = 832,
    GAPC_APPEARANCE_HEART_RATE_SENSOR_HEART_RATE_BELT   = 833,
    GAPC_APPEARANCE_GENERIC_BLOOD_PRESSURE              = 896,
    GAPC_APPEARANCE_BLOOD_PRESSURE_ARM                  = 897,
    GAPC_APPEARANCE_BLOOD_PRESSURE_WRIST                = 898,
    GAPC_APPEARANCE_GENERIC_HID                         = 960,
    GAPC_APPEARANCE_HID_KEYBOARD                        = 961,
    GAPC_APPEARANCE_HID_MOUSE                           = 962,
    GAPC_APPEARANCE_HID_JOYSTICK                        = 963,
    GAPC_APPEARANCE_HID_GAMEPAD                         = 964,
    GAPC_APPEARANCE_HID_DIGITIZER_TABLET                = 965,
    GAPC_APPEARANCE_HID_CARD_READER                     = 966,
    GAPC_APPEARANCE_HID_DIGITAL_PEN                     = 967,
    GAPC_APPEARANCE_HID_BARCODE_SCANNER                 = 968,
    GAPC_APPEARANCE_GENERIC_GLUCOSE_METER               = 1024,
    GAPC_APPEARANCE_GENERIC_RUNNING_WALKING_SENSOR      = 1088,
    GAPC_APPEARANCE_RUNNING_WALKING_SENSOR_IN_SHOE      = 1089,
    GAPC_APPEARANCE_RUNNING_WALKING_SENSOR_ON_SHOE      = 1090,
    GAPC_APPEARANCE_RUNNING_WALKING_SENSOR_ON_HIP       = 1091,
    GAPC_APPEARANCE_GENERIC_CYCLING                     = 1152,
    GAPC_APPEARANCE_CYCLING_CYCLING_COMPUTER            = 1153,
    GAPC_APPEARANCE_CYCLING_SPEED_SENSOR                = 1154,
    GAPC_APPEARANCE_CYCLING_CADENCE_SENSOR              = 1155,
    GAPC_APPEARANCE_CYCLING_POWER_SENSOR                = 1156,
    GAPC_APPEARANCE_CYCLING_SPEED_AND_CADENCE_SENSOR    = 1157,
    GAPC_APPEARANCE_GENERIC_PULSE_OXIMETER              = 3136,
    GAPC_APPEARANCE_PULSE_OXIMETER_FINGERTIP            = 3137,
    GAPC_APPEARANCE_PULSE_OXIMETER_WRIST_WORN           = 3138,
    GAPC_APPEARANCE_GENERIC_WEIGHT_SCALE                = 3200,
    GAPC_APPEARANCE_GENERIC_OUTDOOR_SPORTS_ACTIVITY     = 5184,
    GAPC_APPEARANCE_OUTDOOR_SPORTS_ACT_LOCATION_DISPLAY = 5185,
    GAPC_APPEARANCE_OUTDOOR_SPORTS_ACT_LOCATION_AND_NAVIGATION_DISPLAY = 5186,
    GAPC_APPEARANCE_OUTDOOR_SPORTS_ACT_LOCATION_POD     = 5187,
    GAPC_APPEARANCE_OUTDOOR_SPORTS_ACT_LOCATION_AND_NAVIGATION_POD = 5188,
    // dummy appearance ID
    GAPC_APPEARANCE_LAST,
};
