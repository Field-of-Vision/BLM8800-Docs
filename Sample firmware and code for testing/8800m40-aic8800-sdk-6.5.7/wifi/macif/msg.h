...
enum mm_msg_tag
{
    ...
    MM_SET_ARPOFFLOAD_REQ, //add by aic
    MM_SET_ARPOFFLOAD_CFM, //add by aic
    MM_SET_AGG_DISABLE_REQ, //add by aic
    MM_SET_AGG_DISABLE_CFM, //add by aic                                    // 100
    MM_SET_COEX_REQ, //add by aic
    MM_SET_COEX_CFM, //add by aic
    MM_SET_RF_CONFIG_REQ, //add by aic
    MM_SET_RF_CONFIG_CFM, //add by aic
    MM_SET_RF_CALIB_REQ, //add by aic
    MM_SET_RF_CALIB_CFM, //add by aic
    ...
    MM_SET_TXPWR_LVL_REQ = MM_SET_TXPWR_IDX_REQ,
    MM_SET_TXPWR_IDX_CFM,
    MM_SET_TXPWR_LVL_CFM = MM_SET_TXPWR_IDX_CFM,
...
enum vendor_hwconfig_tag{
    ...
    CCA_THRESHOLD_REQ,
    BWMODE_REQ,
    VHC_RESERVED0,//CHIP_TEMP_GET_REQ,
    CUSTOMIZED_FREQ_REQ = 6,
    WAKEUP_INFO_REQ,
};
...
struct mm_set_mac_timescale_req
{
    ...
    uint8_t sifsB_time;
    uint8_t slot_time;
    uint8_t rx_startdelay_ofdm;
    uint8_t rx_startdelay_long;
    uint8_t rx_startdelay_short;
};
...
struct mm_set_cca_threshold_req
{
    uint32_t hwconfig_id;
    uint8_t auto_cca_en;
    int8_t  cca20p_rise_th;
    int8_t  cca20s_rise_th;
    int8_t  cca20p_fall_th;
    int8_t  cca20s_fall_th;
};
...
#if PLF_AIC8800MC || defined(CFG_WIFI_RAM_VER) || (PLF_AIC8800M40)
...
union fixed_rate_ctrl_info {
    struct {
        u16_l mcsIndexTx      : 7;
        u16_l bwTx            : 2;
        u16_l giAndPreTypeTx  : 2;
        u16_l formatModTx     : 3;
    };
    u16_l value;
};
...
union rwnx_rate_ctrl_info {
    struct {
        u32_l mcsIndexTx      : 7;
        u32_l bwTx            : 2;
        u32_l giAndPreTypeTx  : 2;
        u32_l formatModTx     : 3;
        u32_l navProtFrmEx    : 3;
        u32_l mcsIndexProtTx  : 7;
        u32_l bwProtTx        : 2;
        u32_l formatModProtTx : 3;
        u32_l nRetry          : 3;
    };
    u32_l value;
};
...
enum sm_msg_tag
{
    ...
    #if (!PLF_AIC8800MC && defined(CFG_WIFI_RAM_VER))
...
enum apm_msg_tag
{
    ...
    APM_SET_UPDATE_BASICRATE_REQ,
    APM_SET_UPDATE_BASICRATE_CFM,
...
struct apm_set_bcn_ie_req
{
    uint8_t  vif_idx;
    uint16_t bcn_ie_len;
    uint8_t  bcn_ie[480]; // length is limit to IPC_A2E_MSG_BUF_SIZE*4
};
...
struct dbg_mem_block_write_req
{
    ...
    uint32_t memdata[1024 / sizeof(uint32_t)];
};
...
/// Structure containing the parameters of the @ref DBG_START_NPC_CFM message.
struct dbg_start_npc_cfm
{
    /// Boot status
    uint32_t bootstatus;
};
...
{
    uint32_t cal_cfg_24g; //cal2.4g + 5g
    uint32_t cal_cfg_5g;
    uint32_t param_alpha;
    uint32_t bt_calib_en;
    uint32_t bt_calib_param;
    uint8_t xtal_cap;
    uint8_t xtal_cap_fine;
};

struct mm_set_rf_calib_cfm
{
    uint32_t rxgain_24g_addr;
    uint32_t rxgain_5g_addr;
    uint32_t txgain_24g_addr;
    uint32_t txgain_5g_addr;
};

typedef struct {
    uint8_t enabled;
    uint8_t pwridx_11b_11ag_2g4[12];
    uint8_t pwridx_11n_11ac_2g4[10];
    uint8_t pwridx_11ax_2g4[12];
    uint8_t pwridx_11ag_5g[8];
    uint8_t pwridx_11n_11ac_5g[10];
    uint8_t pwridx_11ax_5g[12];
} txpwr_idx_fine_conf_t;
...
} txpwr_idx_conf_8800_t;

struct mm_set_txpwr_idx_req
{
  union {
    txpwr_idx_conf_8800_t txpwr_idx;
    txpwr_idx_fine_conf_t txpwr_idx_fine;
  };
};

typedef struct {
    uint8_t enabled;
    int8_t  pwrlvl_11b_11ag_2g4[12];
    int8_t  pwrlvl_11n_11ac_2g4[10];
    int8_t  pwrlvl_11ax_2g4[12];
    #if (PLF_AIC8800M40)
    int8_t  pwrlvl_11a_5g[12];
    int8_t  pwrlvl_11n_11ac_5g[10];
    int8_t  pwrlvl_11ax_5g[12];
    #endif
} txpwr_lvl_conf_t;
...
typedef struct {
    uint8_t enabled;
    int8_t pwrofst2x_tbl_2g4[3][3]; //(dsss, high, low)*(ch1-4, ch5-9, ch10-13)
    int8_t pwrofst2x_tbl_5g[3][6]; //(low, high, mid)*(ch42, ch58, ch106, ch122, ch138, ch155)
} txpwr_ofst2x_conf_t;
