...
#define IPC_WIFI_A2E_CPUP_PWRON_CPUS_REQ_POS             5
#define IPC_WIFI_A2E_CPUP_PWRON_CPUS_REQ_BIT             CO_BIT(IPC_WIFI_A2E_CPUP_PWRON_CPUS_REQ_POS)
...
#if (PLF_AIC8800MC || PLF_AIC8800M40)
void ipc_host_wait_emb_state(enum ipc_emb_state_e state);
#endif
#if NX_UF_EN
...
void wifi_disconnected_sleep_allow(int yes);

void wifi_fw_powerup_with_host_alive(void);
void wifi_fw_powerdown_with_host_alive(void);
/**
 ****************************************************************************************
 * @brief Get wifi initial status.
 *
 * @return      1 ready, 0 not ready
 ****************************************************************************************
 */
int wifi_get_init_status(void);
