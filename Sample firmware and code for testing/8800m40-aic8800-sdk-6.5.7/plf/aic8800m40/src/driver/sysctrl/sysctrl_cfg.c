...
const unsigned int clk_cfg_code_tbl[CLK_CFG_MAX] = {
    ...
    CLK_CFG_CODE((                                  CLK_DIV_VALUE_1),1,2,(FLASH_DIV_DLY(CLK_DIV_VALUE_1  ,2,1)                                                                 )), //CLK_CFG_S80P40PS80F40
    CLK_CFG_CODE((                                  CLK_DIV_VALUE_1),1,2,(FLASH_DIV_DLY(CLK_DIV_VALUE_1  ,4,2)                                                                 )), //CLK_CFG_S80P40PS80F20
};
