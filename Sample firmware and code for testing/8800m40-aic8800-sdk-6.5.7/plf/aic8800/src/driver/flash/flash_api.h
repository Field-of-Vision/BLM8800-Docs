...
#define IS_FLASH_MEM_VALID(addr)    ((((unsigned int)(addr) >> 25) == (AIC_FLASH_MEM_BASE >> 25)) || \
                                    (((unsigned int)(addr) >> 26) == (AIC_CACHE0_MEM_BASE >> 26)))   // 0x08000000 ~ 0x0BFFFFFF
#define IS_CODE_IN_FLASH()          (((CODE_START_ADDR >> 25) == (AIC_FLASH_MEM_BASE >> 25)) || ((CODE_START_ADDR >> 26) == (AIC_CACHE0_MEM_BASE >> 26)))
...
/**
 * @brief Erase/write protection for all flash block(for AIC8800MBW NNNN-N2G)
 *        [DEPRECATED] Used as CONFIG_FLASH_BLOCK_PROTECT_VER=1
 ...
 *         Used as CONFIG_FLASH_BLOCK_PROTECT_VER=2
