...
************************************************************/
#define AICBT_BTMODE_DEFAULT        AICBT_BTMODE_BT_ONLY_COANT   //AICBT_BTMODE_BT_ONLY
...
void bt_drv_non_signaling_test_iram_init(void)
{
    ...
    #include "fw_8820_btonly_u03.h"
    src = fw_8820_btonly_u03;
    len = AICBT_FW_8820_BTONLY_U03_SIZE / sizeof(uint32_t);
    #elif AICBT_BTMODE_DEFAULT == AICBT_BTMODE_BT_ONLY_COANT
    #include "fw_8820_coant_u03.h"
    src = fw_8820_coant_u03;
    len = AICBT_FW_8820_COANT_U03_SIZE / sizeof(uint32_t);
    #else
