...
struct prf_disc_sdp_att_info
{
    uint16_t char_hdl;
    uint16_t val_hdl;
    uint8_t  val_prop;
    /// Attribute UUID Length
    uint8_t  val_uuid_len;
    /// Attribute UUID
    uint8_t  val_uuid[ATT_UUID_128_LEN];
    uint16_t desc_hdl;
    /// Attribute UUID Length
    uint8_t  desc_uuid_len;
    /// Attribute UUID
    uint8_t  desc_uuid[ATT_UUID_128_LEN];
};
...
struct prf_disc_sdp_svc_info
{
    ...
    struct prf_disc_sdp_att_info info[__ARRAY_EMPTY];
};
