...
#define AUDIO_CFG_EXT_AIC1000_RESET_PIN     PB_1
#define AUDIO_CFG_EXT_AIC1000_SCL_PIN       PA_15
#define AUDIO_CFG_EXT_AIC1000_SDA_PIN       PA_13

#define AUDIO_CFG_EXT_AIC1000_I2S_IDX       1
#else
