...
python ../../../tools/scons.py -u . PRODUCT=host-wb PLF=aic8800mc BT=armgcc_4_8 BUILD_CMD="$0 $*" AON=off \
        TGT_MODE=ble_wifi_fhostif_ramopt \
        BT_BLE=on BT_AUDIO=off APPS=on BLE_ONLY=on BT_USER=on TGTNAME=ble_wifi_fhostif_ramopt \
        ...
        ROM_VER=auto HEAP_SIZE=0x12800 RAM_OPT=on \
