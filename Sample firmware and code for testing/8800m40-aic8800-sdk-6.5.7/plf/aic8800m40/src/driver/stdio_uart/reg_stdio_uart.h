...
{
    REG_PL_WR(STDIO_UART_IRQCTL_ADDR, (REG_PL_RD(STDIO_UART_IRQCTL_ADDR) & ~((uint32_t)0x00000080)) | (((uint32_t)ptirqen << 7) & ((uint32_t)0x00000080)));
}
...
{
    REG_PL_WR(STDIO_UART_IRQCTL_ADDR, (REG_PL_RD(STDIO_UART_IRQCTL_ADDR) & ~((uint32_t)0x00000008)) | (((uint32_t)msirqen << 3) & ((uint32_t)0x00000008)));
}
...
{
    REG_PL_WR(STDIO_UART_IRQCTL_ADDR, (REG_PL_RD(STDIO_UART_IRQCTL_ADDR) & ~((uint32_t)0x00000004)) | (((uint32_t)lsirqen << 2) & ((uint32_t)0x00000004)));
}
...
{
    REG_PL_WR(STDIO_UART_IRQCTL_ADDR, (REG_PL_RD(STDIO_UART_IRQCTL_ADDR) & ~((uint32_t)0x00000002)) | (((uint32_t)txirqen << 1) & ((uint32_t)0x00000002)));
}
...
{
    REG_PL_WR(STDIO_UART_IRQCTL_ADDR, (REG_PL_RD(STDIO_UART_IRQCTL_ADDR) & ~((uint32_t)0x00000001)) | (((uint32_t)rxirqen << 0) & ((uint32_t)0x00000001)));
}
...
{
    REG_PL_WR(STDIO_UART_DBUFCFG_ADDR, (REG_PL_RD(STDIO_UART_DBUFCFG_ADDR) & ~((uint32_t)0x00000004)) | (((uint32_t)txdrst << 2) & ((uint32_t)0x00000004)));
}

__INLINE void stdio_uart_rxdrst_setf(uint8_t rxdrst)
{
    REG_PL_WR(STDIO_UART_DBUFCFG_ADDR, (REG_PL_RD(STDIO_UART_DBUFCFG_ADDR) & ~((uint32_t)0x00000002)) | (((uint32_t)rxdrst << 1) & ((uint32_t)0x00000002)));
}

__INLINE void stdio_uart_dbufen_setf(uint8_t dbufen)
{
    REG_PL_WR(STDIO_UART_DBUFCFG_ADDR, (REG_PL_RD(STDIO_UART_DBUFCFG_ADDR) & ~((uint32_t)0x00000001)) | (((uint32_t)dbufen << 0) & ((uint32_t)0x00000001)));
}
...
__INLINE void stdio_uart_divms_setf(uint8_t divmode)
{
    ...
    REG_PL_WR(STDIO_UART_DFMTCFG_ADDR, (REG_PL_RD(STDIO_UART_DFMTCFG_ADDR) & ~((uint32_t)0x00000100)) | (((uint32_t)divmode << 8) & ((uint32_t)0x00000100)));
}
...
{
    ASSERT_ERR((((uint32_t)DIVAE << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_PL_WR(STDIO_UART_DFMTCFG_ADDR, (REG_PL_RD(STDIO_UART_DFMTCFG_ADDR) & ~((uint32_t)0x00000080)) | (((uint32_t)DIVAE << 7) & ((uint32_t)0x00000080)));
}
...
{
    ASSERT_ERR((((uint32_t)brk << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_PL_WR(STDIO_UART_DFMTCFG_ADDR, (REG_PL_RD(STDIO_UART_DFMTCFG_ADDR) & ~((uint32_t)0x00000040)) | (((uint32_t)brk << 6) & ((uint32_t)0x00000040)));
}
...
{
    ASSERT_ERR((((uint32_t)eps << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(STDIO_UART_DFMTCFG_ADDR, (REG_PL_RD(STDIO_UART_DFMTCFG_ADDR) & ~((uint32_t)0x00000010)) | (((uint32_t)eps << 4) & ((uint32_t)0x00000010)));
}
...
{
    ASSERT_ERR((((uint32_t)pen << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_PL_WR(STDIO_UART_DFMTCFG_ADDR, (REG_PL_RD(STDIO_UART_DFMTCFG_ADDR) & ~((uint32_t)0x00000008)) | (((uint32_t)pen << 3) & ((uint32_t)0x00000008)));
}
...
{
    ASSERT_ERR((((uint32_t)stop << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_PL_WR(STDIO_UART_DFMTCFG_ADDR, (REG_PL_RD(STDIO_UART_DFMTCFG_ADDR) & ~((uint32_t)0x00000004)) | (((uint32_t)stop << 2) & ((uint32_t)0x00000004)));
}
...
{
    ASSERT_ERR((((uint32_t)dls << 0) & ~((uint32_t)0x00000003)) == 0);
    REG_PL_WR(STDIO_UART_DFMTCFG_ADDR, (REG_PL_RD(STDIO_UART_DFMTCFG_ADDR) & ~((uint32_t)0x00000003)) | (((uint32_t)dls << 0) & ((uint32_t)0x00000003)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000100)) | (((uint32_t)clkp << 8) & ((uint32_t)0x00000100)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000080)) | (((uint32_t)autodet << 7) & ((uint32_t)0x00000080)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000040)) | (((uint32_t)sire << 6) & ((uint32_t)0x00000040)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000020)) | (((uint32_t)afce << 5) & ((uint32_t)0x00000020)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000010)) | (((uint32_t)loopback << 4) & ((uint32_t)0x00000010)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000008)) | (((uint32_t)out2 << 3) & ((uint32_t)0x00000008)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000004)) | (((uint32_t)out1 << 2) & ((uint32_t)0x00000004)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000002)) | (((uint32_t)rts << 1) & ((uint32_t)0x00000002)));
}
...
{
    REG_PL_WR(STDIO_UART_MDMCFG_ADDR, (REG_PL_RD(STDIO_UART_MDMCFG_ADDR) & ~((uint32_t)0x00000001)) | (((uint32_t)dtr << 0) & ((uint32_t)0x00000001)));
}
...
{
    REG_PL_WR(STDIO_UART_DBUFTH_ADDR, (REG_PL_RD(STDIO_UART_DBUFTH_ADDR) & ~((uint32_t)0x0001FE00)) | (((uint32_t)txtrigth << 9) & ((uint32_t)0x0001FE00)));
}
...
{
    REG_PL_WR(STDIO_UART_DBUFTH_ADDR, (REG_PL_RD(STDIO_UART_DBUFTH_ADDR) & ~((uint32_t)0x000000FF)) | (((uint32_t)rxtrigth << 0) & ((uint32_t)0x000000FF)));
}
