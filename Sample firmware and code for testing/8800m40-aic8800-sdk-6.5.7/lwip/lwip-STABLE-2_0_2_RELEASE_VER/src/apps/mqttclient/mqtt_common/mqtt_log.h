...
#else
    #define MQTT_LOG_D(fmt, ...)        { dbg(fmt, ##__VA_ARGS__); dbg("\n");}
...
#else
    #define MQTT_LOG_I(fmt, ...)       { dbg(fmt, ##__VA_ARGS__); dbg("\n");}
// { printf(fmt, ##__VA_ARGS__); printf("\n");}
#endif
...
#else
    #define MQTT_LOG_W(fmt, ...)       { dbg(fmt, ##__VA_ARGS__); dbg("\n");}
// { printf(fmt, ##__VA_ARGS__); printf("\n");}
#endif
...
#else
    #define MQTT_LOG_E(fmt, ...)        { dbg(fmt, ##__VA_ARGS__); dbg("\n");}
//{ printf(fmt, ##__VA_ARGS__); printf("\n");}
#endif
    ...
    #define MQTT_LOG(fmt, ...)
#else
    #define MQTT_LOG(fmt, ...)          { dbg(fmt, ##__VA_ARGS__); dbg("\n");}
//{ printf(fmt, ##__VA_ARGS__); printf("\n");}
#endif
