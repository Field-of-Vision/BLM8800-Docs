...
#define IPC_RXBUF_CNT       17
#else
#define IPC_RXBUF_CNT       11
#endif
#endif
#if (PLF_AIC8800M40)
#if defined(CFG_WIFI_HIB) || !defined(CFG_DPD)
#define IPC_RXBUF_CNT       10
#else /* CFG_WIFI_HIB || !CFG_DPD */
#define IPC_RXBUF_CNT       11
#endif /* CFG_WIFI_HIB || !CFG_DPD */
#endif
#endif
...
#define IPC_IRQ_A2E_WIFICORE_PWRON  CO_BIT(29)
/// IPC APP2EMB flash access request interrupt bit
#define IPC_IRQ_A2E_FLSACC_REQ      CO_BIT(28)
