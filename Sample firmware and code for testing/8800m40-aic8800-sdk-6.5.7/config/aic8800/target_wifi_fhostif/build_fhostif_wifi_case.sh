...
python ../../../tools/scons.py -u . PRODUCT=host-wifi PLF=aic8800 BT=armgcc_4_8 BUILD_CMD="$0 $*" SOFTAP=on PMIC_VER=lite FHOST_APP=fhostif AON=on BAND5G=on ROM_VER=auto \
        TGT_MODE=wifi_fhostif WAPI=on \
        HOSTIF=usb  $opt
