 ...
 *
 * This request will be send to exchange mtu by client.
 *
 * @param[in] prf_env Pointer to profile information
 *
 * @param conidx   Connection index
 * @param max_mtu  Max mtu
 ****************************************************************************************
 */
void prf_gatt_send_exchange_mtu(prf_env_t *prf_env, uint8_t conidx, uint16_t max_mtu);
 ...
 ****************************************************************************************
 */
void prf_disc_svc_all_send(prf_env_t *prf_env, uint8_t conidx, uint8_t uuid_len);
...
uint8_t prf_pre_extract_all_svc_info(const struct gattc_sdp_svc_ind* param);

void prf_extract_all_svc_info(const struct gattc_sdp_svc_ind* param,struct prf_disc_sdp_att_info *info);

void prf_start_smp_bonding(uint8_t conidx,struct gapc_pairing * param);
