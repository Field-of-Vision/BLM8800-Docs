...
python ../../../tools/scons.py -u . PRODUCT=host-wifi PLF=aic8800m40 BT=armgcc_4_8 BUILD_CMD="$0 $*" \
    SOFTAP=on FHOST_APP=fhostif BAND5G=on PING=on IPERF=on \
    TGT_MODE=wifi_fhostif CHKSUM=off WIFI_RAM_VER=on HOSTIF=usb HEAP_SIZE=0x20000 $opt
