...
#define WEBCLIENT_RTOS_PORTING  1

#if (WEBCLIENT_RTOS_PORTING)
#include <stddef.h>
#include <string.h>
#include "dbg.h"
...
#if (WEBCLIENT_RTOS_PORTING)
#ifndef web_malloc
#define web_malloc                      rtos_malloc
#endif

#ifndef web_calloc
#define web_calloc                      rtos_calloc
#endif

#ifndef web_realloc
#define web_realloc                     rtos_realloc
#endif

#ifndef web_free
#define web_free                        rtos_free
#endif
...
#ifndef web_snprintf
#define web_snprintf                    dbg_snprintf
#endif

#ifndef web_vsnprintf
#define web_vsnprintf                   dbg_vsnprintf
#endif

#ifndef web_strdup
#define web_strdup                      dbg_strdup
__STATIC_INLINE char * dbg_strdup(const char *s)
{
    unsigned int len = strlen(s) + 1;
    void *new = rtos_malloc(len);
    if (new == NULL) {
        return NULL;
    }
...
#define RT_EOK                          0
#define RT_NULL                         NULL
#define RT_ASSERT(cond)                 ASSERT_ERR(cond)
