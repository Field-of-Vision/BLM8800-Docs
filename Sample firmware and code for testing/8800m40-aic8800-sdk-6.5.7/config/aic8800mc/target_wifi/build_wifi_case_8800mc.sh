...
python ../../../tools/scons.py -u . PRODUCT=host-wifi PLF=aic8800mc BT=armgcc_4_8 BUILD_CMD="$0 $*" TGT_MODE=wifi SOFTAP=on CHKSUM=off WIFI_RAM_VER=off HEAP_SIZE=0xf000 FHOST_APP=console $opt
