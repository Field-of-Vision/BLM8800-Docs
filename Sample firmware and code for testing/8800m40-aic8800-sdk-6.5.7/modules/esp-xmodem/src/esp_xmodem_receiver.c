...
#define ESP_XMODEM_RECEIVER_TASK_SIZE 512//2048
...
esp_err_t esp_xmodem_receiver_start(esp_xmodem_handle_t receiver)
{
    ...
    if (rtos_task_create(esp_xmodem_receive_process, "xmodem_recv", XMDM_RECV_TASK, ESP_XMODEM_RECEIVER_TASK_SIZE, receiver, ESP_XMODEM_RECEIVER_TASK_PRIO, &receiver->process_handle)) {
