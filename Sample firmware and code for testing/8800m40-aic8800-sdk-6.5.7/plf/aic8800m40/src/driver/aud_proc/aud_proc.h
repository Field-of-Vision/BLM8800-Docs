...
typedef volatile struct
{
    ...
    __IO uint32_t                          aud_src_hpf_coef1_a1;         //0x00000128
    __IO uint32_t                          aud_src_hpf_coef1_a2;         //0x0000012C
    __IO uint32_t                          aud_src_hpf_coef1_b1;         //0x00000130
    __IO uint32_t                          aud_src_hpf_coef1_g0;         //0x00000134
    __IO uint32_t                          aud_src_lpf_coef2_a1;         //0x00000138
    __IO uint32_t                          aud_src_lpf_coef2_a2;         //0x0000013C
    __IO uint32_t                          aud_src_lpf_coef2_b1;         //0x00000140
    __IO uint32_t                          aud_src_lpf_coef2_g0;         //0x00000144
    __IO uint32_t                          aud_src_lpf_coef3_a1;         //0x00000148
    __IO uint32_t                          aud_src_lpf_coef3_a2;         //0x0000014C
    __IO uint32_t                          aud_src_lpf_coef3_b1;         //0x00000150
    __IO uint32_t                          aud_src_lpf_coef3_g0;         //0x00000154
    __IO uint32_t                          aud_adc_hpf_coef1_a1;         //0x00000158
    __IO uint32_t                          aud_adc_hpf_coef1_a2;         //0x0000015C
    __IO uint32_t                          aud_adc_hpf_coef1_b1;         //0x00000160
    __IO uint32_t                          aud_adc_hpf_coef1_g0;         //0x00000164
    __IO uint32_t                          aud_adc_lpf_coef2_a1;         //0x00000168
    __IO uint32_t                          aud_adc_lpf_coef2_a2;         //0x0000016C
    __IO uint32_t                          aud_adc_lpf_coef2_b1;         //0x00000170
    __IO uint32_t                          aud_adc_lpf_coef2_g0;         //0x00000174
    __IO uint32_t                          aud_adc_lpf_coef3_a1;         //0x00000178
    __IO uint32_t                          aud_adc_lpf_coef3_a2;         //0x0000017C
    __IO uint32_t                          aud_adc_lpf_coef3_b1;         //0x00000180
    __IO uint32_t                          aud_adc_lpf_coef3_g0;         //0x00000184
    __IO uint32_t Reserved_00000188[2];                 //0x00000188
    __IO uint32_t                          eq_coef_ram_cfg3;             //0x00000190
    __IO uint32_t                          aud_adc_drc_cfg0;             //0x00000194
    __IO uint32_t                          aud_adc_drc_ram_cfg0;         //0x00000198
    __IO uint32_t                          aud_adc_drc_ram_cfg1;         //0x0000019C
    __IO uint32_t                          aud_adc_drc_ram_cfg2;         //0x000001A0
} HWP_AUD_PROC_T;
...
#define AUD_PROC_TX_FIFO_STAT_CH_0(n)      (((n)&3)<<4)
#define AUD_PROC_TX_FIFO_STAT_CH_0_LSB     (4)
#define AUD_PROC_TX_FIFO_STAT_CH_0_MASK    (3<<4)
...
#define AUD_PROC_TX_FIFO_STAT_CH_2(n)      (((n)&3)<<4)
#define AUD_PROC_TX_FIFO_STAT_CH_2_LSB     (4)
#define AUD_PROC_TX_FIFO_STAT_CH_2_MASK    (3<<4)
...
#define AUD_PROC_RX_EN_CH_1             (1<<6)
#define AUD_PROC_RX_EN_CH_1_POS         (6)
...
#define AUD_PROC_RX_EN_CH_3             (1<<6)
#define AUD_PROC_RX_EN_CH_3_POS         (6)
...
#define AUD_PROC_EQ_STAGE(n)            (((n)&31)<<8)
#define AUD_PROC_EQ_STAGE_LSB           (8)
#define AUD_PROC_EQ_STAGE_MASK          (31<<8)
#define AUD_PROC_EQ_CLR_DONE            (1<<13)
#define AUD_PROC_EQ_CLR_DONE_POS        (13)
#define AUD_PROC_EQ_CLR                 (1<<14)
#define AUD_PROC_EQ_CLR_POS             (14)
#define AUD_PROC_SRC_CLR                (1<<15)
#define AUD_PROC_SRC_CLR_POS            (15)
#define AUD_PROC_TX_SERIAL_DATA_STAT(n)      (((n)&3)<<16)
#define AUD_PROC_TX_SERIAL_DATA_STAT_LSB     (16)
#define AUD_PROC_TX_SERIAL_DATA_STAT_MASK    (3<<16)
#define AUD_PROC_TX_PARALLEL_DATA_STAT(n)      (((n)&3)<<18)
#define AUD_PROC_TX_PARALLEL_DATA_STAT_LSB     (18)
#define AUD_PROC_TX_PARALLEL_DATA_STAT_MASK    (3<<18)
#define AUD_PROC_SRC_FLT_BYPASS(n)      (((n)&15)<<20)
#define AUD_PROC_SRC_FLT_BYPASS_LSB     (20)
#define AUD_PROC_SRC_FLT_BYPASS_MASK    (15<<20)
#define AUD_PROC_AUD_PROC_DAC_TRIG_EN      (1<<24)
#define AUD_PROC_AUD_PROC_DAC_TRIG_EN_POS  (24)
#define AUD_PROC_AUD_PROC_TX_I2S_TRIG_EN      (1<<25)
#define AUD_PROC_AUD_PROC_TX_I2S_TRIG_EN_POS  (25)

//aud_proc_adc_cfg1
#define AUD_PROC_ADC01_VOLUME_L(n)      (((n)&0xFF)<<0)
#define AUD_PROC_ADC01_VOLUME_L_LSB     (0)
#define AUD_PROC_ADC01_VOLUME_L_MASK    (0xFF<<0)
#define AUD_PROC_ADC01_VOLUME_R(n)      (((n)&0xFF)<<8)
#define AUD_PROC_ADC01_VOLUME_R_LSB     (8)
#define AUD_PROC_ADC01_VOLUME_R_MASK    (0xFF<<8)
#define AUD_PROC_ADC23_VOLUME_L(n)      (((n)&0xFF)<<16)
#define AUD_PROC_ADC23_VOLUME_L_LSB     (16)
#define AUD_PROC_ADC23_VOLUME_L_MASK    (0xFF<<16)
#define AUD_PROC_ADC23_VOLUME_R(n)      (((n)&0xFF)<<24)
#define AUD_PROC_ADC23_VOLUME_R_LSB     (24)
#define AUD_PROC_ADC23_VOLUME_R_MASK    (0xFF<<24)
...
#define AUD_PROC_ADC1_SOURCE_SEL        (1<<25)
#define AUD_PROC_ADC1_SOURCE_SEL_POS    (25)
#define AUD_PROC_ADC2_SOURCE_SEL        (1<<26)
#define AUD_PROC_ADC2_SOURCE_SEL_POS    (26)
#define AUD_PROC_ADC_SYNC_MODE          (1<<27)
#define AUD_PROC_ADC_SYNC_MODE_POS      (27)
#define AUD_PROC_LOOP_VOLUME(n)         (((n)&15)<<28)
#define AUD_PROC_LOOP_VOLUME_LSB        (28)
#define AUD_PROC_LOOP_VOLUME_MASK       (15<<28)
...
#define AUD_PROC_TX_CH01_IIS_EN_MUX      (1<<15)
#define AUD_PROC_TX_CH01_IIS_EN_MUX_POS  (15)
#define AUD_PROC_RX_CH01_IIS_EN_MUX      (1<<16)
#define AUD_PROC_RX_CH01_IIS_EN_MUX_POS  (16)
...
#define AUD_PROC_TX_CH23_IIS_EN_MUX      (1<<15)
#define AUD_PROC_TX_CH23_IIS_EN_MUX_POS  (15)
#define AUD_PROC_RX_CH23_IIS_EN_MUX      (1<<16)
#define AUD_PROC_RX_CH23_IIS_EN_MUX_POS  (16)
...
#define AUD_PROC_CFG_DRC_CROSSOVER_BYPASS      (1<<15)
#define AUD_PROC_CFG_DRC_CROSSOVER_BYPASS_POS  (15)
...
#define AUD_PROC_EQ_STEREO_COEF_WDATA(n)      (((n)&0x3FFFFFFF)<<0)
#define AUD_PROC_EQ_STEREO_COEF_WDATA_LSB     (0)
#define AUD_PROC_EQ_STEREO_COEF_WDATA_MASK    (0x3FFFFFFF<<0)
#define AUD_PROC_EQ_STEREO_COEF_WR      (1<<31)
#define AUD_PROC_EQ_STEREO_COEF_WR_POS  (31)

//eq_stereo_coef_ram_cfg1
#define AUD_PROC_EQ_STEREO_COEF_RDATA(n)      (((n)&0x3FFFFFFF)<<0)
#define AUD_PROC_EQ_STEREO_COEF_RDATA_LSB     (0)
#define AUD_PROC_EQ_STEREO_COEF_RDATA_MASK    (0x3FFFFFFF<<0)
#define AUD_PROC_EQ_STEREO_COEF_RD      (1<<31)
#define AUD_PROC_EQ_STEREO_COEF_RD_POS  (31)

//eq_mono_coef_ram_cfg0
#define AUD_PROC_EQ_MONO_COEF_WDATA(n)      (((n)&0x3FFFFFFF)<<0)
#define AUD_PROC_EQ_MONO_COEF_WDATA_LSB     (0)
#define AUD_PROC_EQ_MONO_COEF_WDATA_MASK    (0x3FFFFFFF<<0)
#define AUD_PROC_EQ_MONO_COEF_WR        (1<<31)
#define AUD_PROC_EQ_MONO_COEF_WR_POS    (31)

//eq_mono_coef_ram_cfg1
#define AUD_PROC_EQ_MONO_COEF_RDATA(n)      (((n)&0x3FFFFFFF)<<0)
#define AUD_PROC_EQ_MONO_COEF_RDATA_LSB     (0)
#define AUD_PROC_EQ_MONO_COEF_RDATA_MASK    (0x3FFFFFFF<<0)
#define AUD_PROC_EQ_MONO_COEF_RD        (1<<31)
#define AUD_PROC_EQ_MONO_COEF_RD_POS    (31)
...
#define AUD_PROC_AUD_SRC_IIR_HPF_BYPASS      (1<<17)
#define AUD_PROC_AUD_SRC_IIR_HPF_BYPASS_POS  (17)
#define AUD_PROC_AUD_SRC_IIR_BANK_EN      (1<<18)
#define AUD_PROC_AUD_SRC_IIR_BANK_EN_POS  (18)
#define AUD_PROC_AUD_SRC_IIR_FLT_STAGE(n)      (((n)&7)<<19)
#define AUD_PROC_AUD_SRC_IIR_FLT_STAGE_LSB     (19)
#define AUD_PROC_AUD_SRC_IIR_FLT_STAGE_MASK    (7<<19)
#define AUD_PROC_AUD_ADC_IIR_HPF_BYPASS      (1<<22)
#define AUD_PROC_AUD_ADC_IIR_HPF_BYPASS_POS  (22)
#define AUD_PROC_AUD_ADC_IIR_BANK_EN      (1<<23)
#define AUD_PROC_AUD_ADC_IIR_BANK_EN_POS  (23)
#define AUD_PROC_AUD_ADC_IIR_FLT_STAGE(n)      (((n)&7)<<24)
#define AUD_PROC_AUD_ADC_IIR_FLT_STAGE_LSB     (24)
#define AUD_PROC_AUD_ADC_IIR_FLT_STAGE_MASK    (7<<24)

//aud_src_hpf_coef1_a1
#define AUD_PROC_AUD_SRC_HPF_COEF1_A1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_hpf_coef1_a2
#define AUD_PROC_AUD_SRC_HPF_COEF1_A2_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A2_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A2_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_hpf_coef1_b1
#define AUD_PROC_AUD_SRC_HPF_COEF1_B1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_B1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_B1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_hpf_coef1_g0
#define AUD_PROC_AUD_SRC_HPF_COEF1_G0(n)      (((n)&0xFFFFF)<<0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_G0_LSB     (0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_G0_MASK    (0xFFFFF<<0)
#define AUD_PROC_AUD_SRC_HPF_COEF1_B1_LOW4(n)      (((n)&15)<<20)
#define AUD_PROC_AUD_SRC_HPF_COEF1_B1_LOW4_LSB     (20)
#define AUD_PROC_AUD_SRC_HPF_COEF1_B1_LOW4_MASK    (15<<20)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A2_LOW4(n)      (((n)&15)<<24)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A2_LOW4_LSB     (24)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A2_LOW4_MASK    (15<<24)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A1_LOW4(n)      (((n)&15)<<28)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A1_LOW4_LSB     (28)
#define AUD_PROC_AUD_SRC_HPF_COEF1_A1_LOW4_MASK    (15<<28)

//aud_src_lpf_coef2_a1
#define AUD_PROC_AUD_SRC_LPF_COEF2_A1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_lpf_coef2_a2
#define AUD_PROC_AUD_SRC_LPF_COEF2_A2_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A2_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A2_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_lpf_coef2_b1
#define AUD_PROC_AUD_SRC_LPF_COEF2_B1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_B1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_B1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_lpf_coef2_g0
#define AUD_PROC_AUD_SRC_LPF_COEF2_G0(n)      (((n)&0xFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_G0_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_G0_MASK    (0xFFFFF<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF2_B1_LOW4(n)      (((n)&15)<<20)
#define AUD_PROC_AUD_SRC_LPF_COEF2_B1_LOW4_LSB     (20)
#define AUD_PROC_AUD_SRC_LPF_COEF2_B1_LOW4_MASK    (15<<20)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A2_LOW4(n)      (((n)&15)<<24)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A2_LOW4_LSB     (24)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A2_LOW4_MASK    (15<<24)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A1_LOW4(n)      (((n)&15)<<28)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A1_LOW4_LSB     (28)
#define AUD_PROC_AUD_SRC_LPF_COEF2_A1_LOW4_MASK    (15<<28)

//aud_src_lpf_coef3_a1
#define AUD_PROC_AUD_SRC_LPF_COEF3_A1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_lpf_coef3_a2
#define AUD_PROC_AUD_SRC_LPF_COEF3_A2_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A2_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A2_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_lpf_coef3_b1
#define AUD_PROC_AUD_SRC_LPF_COEF3_B1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_B1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_B1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_src_lpf_coef3_g0
#define AUD_PROC_AUD_SRC_LPF_COEF3_G0(n)      (((n)&0xFFFFF)<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_G0_LSB     (0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_G0_MASK    (0xFFFFF<<0)
#define AUD_PROC_AUD_SRC_LPF_COEF3_B1_LOW4(n)      (((n)&15)<<20)
#define AUD_PROC_AUD_SRC_LPF_COEF3_B1_LOW4_LSB     (20)
#define AUD_PROC_AUD_SRC_LPF_COEF3_B1_LOW4_MASK    (15<<20)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A2_LOW4(n)      (((n)&15)<<24)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A2_LOW4_LSB     (24)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A2_LOW4_MASK    (15<<24)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A1_LOW4(n)      (((n)&15)<<28)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A1_LOW4_LSB     (28)
#define AUD_PROC_AUD_SRC_LPF_COEF3_A1_LOW4_MASK    (15<<28)

//aud_adc_hpf_coef1_a1
#define AUD_PROC_AUD_ADC_HPF_COEF1_A1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_hpf_coef1_a2
#define AUD_PROC_AUD_ADC_HPF_COEF1_A2_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A2_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A2_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_hpf_coef1_b1
#define AUD_PROC_AUD_ADC_HPF_COEF1_B1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_B1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_B1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_hpf_coef1_g0
#define AUD_PROC_AUD_ADC_HPF_COEF1_G0(n)      (((n)&0xFFFFF)<<0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_G0_LSB     (0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_G0_MASK    (0xFFFFF<<0)
#define AUD_PROC_AUD_ADC_HPF_COEF1_B1_LOW4(n)      (((n)&15)<<20)
#define AUD_PROC_AUD_ADC_HPF_COEF1_B1_LOW4_LSB     (20)
#define AUD_PROC_AUD_ADC_HPF_COEF1_B1_LOW4_MASK    (15<<20)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A2_LOW4(n)      (((n)&15)<<24)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A2_LOW4_LSB     (24)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A2_LOW4_MASK    (15<<24)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A1_LOW4(n)      (((n)&15)<<28)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A1_LOW4_LSB     (28)
#define AUD_PROC_AUD_ADC_HPF_COEF1_A1_LOW4_MASK    (15<<28)

//aud_adc_lpf_coef2_a1
#define AUD_PROC_AUD_ADC_LPF_COEF2_A1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_lpf_coef2_a2
#define AUD_PROC_AUD_ADC_LPF_COEF2_A2_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A2_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A2_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_lpf_coef2_b1
#define AUD_PROC_AUD_ADC_LPF_COEF2_B1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_B1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_B1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_lpf_coef2_g0
#define AUD_PROC_AUD_ADC_LPF_COEF2_G0(n)      (((n)&0xFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_G0_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_G0_MASK    (0xFFFFF<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF2_B1_LOW4(n)      (((n)&15)<<20)
#define AUD_PROC_AUD_ADC_LPF_COEF2_B1_LOW4_LSB     (20)
#define AUD_PROC_AUD_ADC_LPF_COEF2_B1_LOW4_MASK    (15<<20)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A2_LOW4(n)      (((n)&15)<<24)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A2_LOW4_LSB     (24)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A2_LOW4_MASK    (15<<24)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A1_LOW4(n)      (((n)&15)<<28)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A1_LOW4_LSB     (28)
#define AUD_PROC_AUD_ADC_LPF_COEF2_A1_LOW4_MASK    (15<<28)

//aud_adc_lpf_coef3_a1
#define AUD_PROC_AUD_ADC_LPF_COEF3_A1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_lpf_coef3_a2
#define AUD_PROC_AUD_ADC_LPF_COEF3_A2_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A2_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A2_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_lpf_coef3_b1
#define AUD_PROC_AUD_ADC_LPF_COEF3_B1_HIGH32(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_B1_HIGH32_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_B1_HIGH32_MASK    (0xFFFFFFFF<<0)

//aud_adc_lpf_coef3_g0
#define AUD_PROC_AUD_ADC_LPF_COEF3_G0(n)      (((n)&0xFFFFF)<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_G0_LSB     (0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_G0_MASK    (0xFFFFF<<0)
#define AUD_PROC_AUD_ADC_LPF_COEF3_B1_LOW4(n)      (((n)&15)<<20)
#define AUD_PROC_AUD_ADC_LPF_COEF3_B1_LOW4_LSB     (20)
#define AUD_PROC_AUD_ADC_LPF_COEF3_B1_LOW4_MASK    (15<<20)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A2_LOW4(n)      (((n)&15)<<24)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A2_LOW4_LSB     (24)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A2_LOW4_MASK    (15<<24)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A1_LOW4(n)      (((n)&15)<<28)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A1_LOW4_LSB     (28)
#define AUD_PROC_AUD_ADC_LPF_COEF3_A1_LOW4_MASK    (15<<28)

//eq_coef_ram_cfg3
#define AUD_PROC_EQ_STEREO_COEF_ADDR(n)      (((n)&0xFF)<<0)
#define AUD_PROC_EQ_STEREO_COEF_ADDR_LSB     (0)
#define AUD_PROC_EQ_STEREO_COEF_ADDR_MASK    (0xFF<<0)
#define AUD_PROC_EQ_MONO_COEF_ADDR(n)      (((n)&0x3F)<<16)
#define AUD_PROC_EQ_MONO_COEF_ADDR_LSB     (16)
#define AUD_PROC_EQ_MONO_COEF_ADDR_MASK    (0x3F<<16)

//aud_adc_drc_cfg0
#define AUD_PROC_CFG_ADC_DRC_CHNL_EN(n)      (((n)&3)<<0)
#define AUD_PROC_CFG_ADC_DRC_CHNL_EN_LSB     (0)
#define AUD_PROC_CFG_ADC_DRC_CHNL_EN_MASK    (3<<0)
#define AUD_PROC_CFG_ADC_DRC_CLR        (1<<8)
#define AUD_PROC_CFG_ADC_DRC_CLR_POS    (8)
#define AUD_PROC_AUD_ADC_DRC_CLR_DONE      (1<<9)
#define AUD_PROC_AUD_ADC_DRC_CLR_DONE_POS  (9)
#define AUD_PROC_CFG_ADC_DRC_BAND_MODE(n)      (((n)&7)<<10)
#define AUD_PROC_CFG_ADC_DRC_BAND_MODE_LSB     (10)
#define AUD_PROC_CFG_ADC_DRC_BAND_MODE_MASK    (7<<10)
#define AUD_PROC_CFG_ADC_DRC_EN         (1<<13)
#define AUD_PROC_CFG_ADC_DRC_EN_POS     (13)
#define AUD_PROC_CFG_ADC_DRC_AUTO_CLK_GATING      (1<<14)
#define AUD_PROC_CFG_ADC_DRC_AUTO_CLK_GATING_POS  (14)

//aud_adc_drc_ram_cfg0
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_WR      (1<<0)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_WR_POS  (0)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_RD      (1<<1)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_RD_POS  (1)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_ADDR(n)      (((n)&0x7F)<<8)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_ADDR_LSB     (8)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_ADDR_MASK    (0x7F<<8)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_SEL(n)      (((n)&3)<<16)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_SEL_LSB     (16)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_SEL_MASK    (3<<16)

//aud_adc_drc_ram_cfg1
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_WDATA(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_WDATA_LSB     (0)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_WDATA_MASK    (0xFFFFFFFF<<0)

//aud_adc_drc_ram_cfg2
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_RDATA(n)      (((n)&0xFFFFFFFF)<<0)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_RDATA_LSB     (0)
#define AUD_PROC_CFG_AUD_ADC_DRC_RAM_RDATA_MASK    (0xFFFFFFFF<<0)
