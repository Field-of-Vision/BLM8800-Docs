...
/**
 * M2D gpio pin default pulled up or down
 *  if pulled up, gpio will set down after trigger
 *  if pulled down, gpio will set high level after trigger
 */
#define CONFIG_M2D_DEFAULT_PULLED_UP  1

/**
 * Soft Watch Dog default time in second.
 */
