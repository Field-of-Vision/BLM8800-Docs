...
#if defined(CFG_PRF_SMARTCONFIGS)
#define BLE_SMARTCONFIG    1
#else
#define BLE_SMARTCONFIG    0
#endif

/// Audtransmit Service Server Role
#if defined(CFG_PRF_AUDTRANSMITS)
#define BLE_AUDTRANSMIT_SERVER          1
#else
#define BLE_AUDTRANSMIT_SERVER          0
#endif // defined(CFG_PRF_AUDTRANSMITS)

/// Audtransmit Service Client Role
#if defined(CFG_PRF_AUDTRANSMITC)
#define BLE_AUDTRANSMIT_CLIENT          1
#else
#define BLE_AUDTRANSMIT_CLIENT          0
#endif // defined(CFG_PRF_AUDTRANSMITC)

/// User Defined Service Server Role
#if defined(CFG_PRF_UDFS)
#define BLE_UDF_SERVER          1
#else
#define BLE_UDF_SERVER          0
#endif // defined(CFG_PRF_AUDTRANSMITS)

/// User Defined Service Client Role
#if defined(CFG_PRF_UDFC)
#define BLE_UDF_CLIENT          1
#else
#define BLE_UDF_CLIENT          0
#endif

/// BLE_CLIENT_PRF indicates if at least one client profile is present
#if (1  || BLE_PROX_MONITOR || BLE_FINDME_LOCATOR || BLE_HT_COLLECTOR || BLE_BP_COLLECTOR \
        ...
        || BLE_CGM_CLIENT || BLE_DBG_THPP || BLE_AUDTRANSMIT_CLIENT || BLE_UDF_CLIENT)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
#if (1  || BLE_PROX_REPORTER || BLE_FINDME_TARGET || BLE_HT_THERMOM || BLE_BP_SENSOR \
        ...
        || BLE_CGM_SERVER || BLE_DBG_THPP || BLE_SMARTCONFIG || BLE_AUDTRANSMIT_SERVER || BLE_UDF_SERVER)
