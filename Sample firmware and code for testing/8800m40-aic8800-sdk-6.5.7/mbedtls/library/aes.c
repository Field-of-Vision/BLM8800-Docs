...
#else  /* !MBEDTLS_AES_SETKEY_ENC_ALT */
int mbedtls_aes_setkey_enc( mbedtls_aes_context *ctx, const unsigned char *key,
                    unsigned int keybits )
{
    //dbg("%s, %d\r\n", __func__, keybits);
...
#else  /* !MBEDTLS_AES_SETKEY_DEC_ALT */
int mbedtls_aes_setkey_dec( mbedtls_aes_context *ctx, const unsigned char *key,
                    unsigned int keybits )
{
    ctx->rk = ctx->buf;
 ...
 */
#ifndef MBEDTLS_AES_ENCRYPT_ECB_ALT
...
#else /* MBEDTLS_AES_ENCRYPT_ECB_ALT */
int mbedtls_aes_crypt_ecb( mbedtls_aes_context *ctx,
                    int mode,
                    const unsigned char input[16],
                    unsigned char output[16] )
...
#endif /* MBEDTLS_AES_ENCRYPT_ECB_ALT */

#if defined(MBEDTLS_CIPHER_MODE_CBC)
/*
 * AES-CBC buffer encryption/decryption
 */
#ifndef MBEDTLS_AES_ENCRYPT_CBC_ALT
...
#else /*MBEDTLS_AES_ENCRYPT_CBC_ALT*/
int mbedtls_aes_crypt_cbc( mbedtls_aes_context *ctx,
                    int mode,
                    size_t length,
                    unsigned char iv[16],
...
#endif /*MBEDTLS_AES_ENCRYPT_CBC_ALT*/
