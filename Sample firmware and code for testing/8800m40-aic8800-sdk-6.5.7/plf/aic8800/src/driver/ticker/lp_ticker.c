...
/// Match interrupt status raw bit
#define LPT_MINT_ST_RAW_BIT     (0x01UL << LP_TICKER_TIMER_MRi)
/// Wrap interrupt status raw bit
#define LPT_WINT_ST_RAW_BIT     (0x01UL << 7)
...
{
    return (sw_rec_lpticker_irqstatus & LPT_WINT_ST_RAW_BIT) ? true : false;
}
