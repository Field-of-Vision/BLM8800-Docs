...
#define AICBT_PATCH_BASE_ADDR_U02              0x10ac9c

#define AICBT_ADID_RAM_BASE_ADDR_U02           0x001017d8
#define AICBT_ADID_ROM_BASE_ADDR_U02           0x000ae150
#define AICBT_ADID_SIZE_U02                    0x5bc
