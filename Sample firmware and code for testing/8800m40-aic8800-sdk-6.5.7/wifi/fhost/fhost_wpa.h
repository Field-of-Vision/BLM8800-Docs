...
int fhost_wpa_create_network1(int fhost_vif_idx, char *net_cfg, bool enable, int timeout_ms);
...
int fhost_wap_cfg_str_escape(char *in_out, int len);

int fhost_wap_cfg_str_unescape(char *in_out, int len);
