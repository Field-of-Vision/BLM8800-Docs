...
void sdmmc_init(void)
{
    ...
    #endif
    // iomux for sdmmc
    iomux_gpioa_config_sel_setf(10, 4); // d2
    iomux_gpioa_config_sel_setf(11, 4); // d3
    iomux_gpioa_config_sel_setf(12, 4); // cmd
    iomux_gpioa_config_sel_setf(13, 4); // clk
    iomux_gpioa_config_sel_setf(14, 4); // d0
    iomux_gpioa_config_sel_setf(15, 4); // d1
}
