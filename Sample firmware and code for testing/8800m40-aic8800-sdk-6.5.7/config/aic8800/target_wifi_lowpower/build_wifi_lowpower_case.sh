...
python ../../../tools/scons.py -u . PRODUCT=host-wifi PLF=aic8800 BT=armgcc_4_8 BUILD_CMD="$0 $*" \
        TGT_MODE=wifi_lowpower BAND5G=on AON=on WIFI_HIB=on \
        SOFTAP=on PMIC_VER=lite FHOST_APP=console \
        HEAP_SIZE=0x10000 WAPI=off FHOST_APP=console TGTNAME=host_wb_console_lowpower $opt
