...
def pack_image_lzma(filename, version):
    ...
    # image_user_ota
    ota_type = 0
    header = struct.pack("<IIII16sIIII", magic, addr, lzma_size, lzma_crc32, version, ota_type, encrypt_algo, crc32, size)
...
if __name__ == "__main__":
    ...
    image_vers = sys.argv[1]
    print '<-input-> image_vers: ', image_vers

    pack_image_lzma('host_wb_upg.bin', image_vers)