 ...
 * Register Name : ASC WDTRE
 */

#define ASC_WDTRE_WDT0_RST_EN_POS       (0)
#define ASC_WDTRE_WDT0_RST_EN_BIT       (0x01UL << ASC_WDTRE_WDT0_RST_EN_POS)
#define ASC_WDTRE_WDT1_RST_EN_POS       (1)
#define ASC_WDTRE_WDT1_RST_EN_BIT       (0x01UL << ASC_WDTRE_WDT1_RST_EN_POS)
#define ASC_WDTRE_WDT2_RST_EN_POS       (2)
#define ASC_WDTRE_WDT2_RST_EN_BIT       (0x01UL << ASC_WDTRE_WDT2_RST_EN_POS)
#define ASC_WDTRE_WDT3_RST_EN_POS       (3)
#define ASC_WDTRE_WDT3_RST_EN_BIT       (0x01UL << ASC_WDTRE_WDT3_RST_EN_POS)
#define ASC_WDTRE_WDT4_RST_EN_POS       (4)
#define ASC_WDTRE_WDT4_RST_EN_BIT       (0x01UL << ASC_WDTRE_WDT4_RST_EN_POS)
#define ASC_WDTRE_CPUP_SYSRST_EN_POS    (5)
#define ASC_WDTRE_CPUP_SYSRST_EN_BIT    (0x01UL << ASC_WDTRE_CPUP_SYSRST_EN_POS)
#define ASC_WDTRE_CPUSW_SYSRST_EN_POS   (6)
#define ASC_WDTRE_CPUSW_SYSRST_EN_BIT   (0x01UL << ASC_WDTRE_CPUSW_SYSRST_EN_POS)
#define ASC_WDTRE_DSP_SYSRST_EN_POS     (7)
#define ASC_WDTRE_DSP_SYSRST_EN_BIT     (0x01UL << ASC_WDTRE_DSP_SYSRST_EN_POS)
#define ASC_WDTRE_CPUSB_SYSRST_EN_POS   (8)
#define ASC_WDTRE_CPUSB_SYSRST_EN_BIT   (0x01UL << ASC_WDTRE_CPUSB_SYSRST_EN_POS)
#define ASC_WDTRE_CPUAON_SYSRST_EN_POS  (9)
#define ASC_WDTRE_CPUAON_SYSRST_EN_BIT  (0x01UL << ASC_WDTRE_CPUAON_SYSRST_EN_POS)

__STATIC_INLINE uint8_t aonsysctrl_wdtre_wdt0_rst_en_getb(void)
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_WDT0_RST_EN_BIT) >> ASC_WDTRE_WDT0_RST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_wdt0_rst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_WDT0_RST_EN_BIT;
}
...
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_WDT1_RST_EN_BIT) >> ASC_WDTRE_WDT1_RST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_wdt1_rst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_WDT1_RST_EN_BIT;
}
...
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_WDT2_RST_EN_BIT) >> ASC_WDTRE_WDT2_RST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_wdt2_rst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_WDT2_RST_EN_BIT;
}
...
__STATIC_INLINE uint8_t aonsysctrl_wdtre_wdt3_rst_en_getb(void)
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_WDT3_RST_EN_BIT) >> ASC_WDTRE_WDT3_RST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_wdt3_rst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_WDT3_RST_EN_BIT;
}

__STATIC_INLINE void aonsysctrl_wdtre_wdt3_rst_en_clrb(void)
{
    AIC_AONSYSCTRL->WDTRE &= ~ASC_WDTRE_WDT3_RST_EN_BIT;
}

__STATIC_INLINE uint8_t aonsysctrl_wdtre_wdt4_rst_en_getb(void)
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_WDT4_RST_EN_BIT) >> ASC_WDTRE_WDT4_RST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_wdt4_rst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_WDT4_RST_EN_BIT;
}

__STATIC_INLINE void aonsysctrl_wdtre_wdt4_rst_en_clrb(void)
{
    AIC_AONSYSCTRL->WDTRE &= ~ASC_WDTRE_WDT4_RST_EN_BIT;
}
...
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_CPUP_SYSRST_EN_BIT) >> ASC_WDTRE_CPUP_SYSRST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_cpup_sysrst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_CPUP_SYSRST_EN_BIT;
}
...
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_CPUSW_SYSRST_EN_BIT) >> ASC_WDTRE_CPUSW_SYSRST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_cpusw_sysrst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_CPUSW_SYSRST_EN_BIT;
}
...
__STATIC_INLINE uint8_t aonsysctrl_wdtre_dsp_sysrst_en_getb(void)
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_DSP_SYSRST_EN_BIT) >> ASC_WDTRE_DSP_SYSRST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_dsp_sysrst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_DSP_SYSRST_EN_BIT;
}

__STATIC_INLINE void aonsysctrl_wdtre_dsp_sysrst_en_clrb(void)
{
    AIC_AONSYSCTRL->WDTRE &= ~ASC_WDTRE_DSP_SYSRST_EN_BIT;
}
...
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_CPUSB_SYSRST_EN_BIT) >> ASC_WDTRE_CPUSB_SYSRST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_cpusb_sysrst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_CPUSB_SYSRST_EN_BIT;
}
...
__STATIC_INLINE uint8_t aonsysctrl_wdtre_cpuaon_sysrst_en_getb(void)
{
    return (AIC_AONSYSCTRL->WDTRE & ASC_WDTRE_CPUAON_SYSRST_EN_BIT) >> ASC_WDTRE_CPUAON_SYSRST_EN_POS;
}

__STATIC_INLINE void aonsysctrl_wdtre_cpuaon_sysrst_en_setb(void)
{
    AIC_AONSYSCTRL->WDTRE |=  ASC_WDTRE_CPUAON_SYSRST_EN_BIT;
}

__STATIC_INLINE void aonsysctrl_wdtre_cpuaon_sysrst_en_clrb(void)
{
    AIC_AONSYSCTRL->WDTRE &= ~ASC_WDTRE_CPUAON_SYSRST_EN_BIT;
}
...
#define CSC_CACHEBP_CACHE0_BYPASS_POS           (0)
#define CSC_CACHEBP_CACHE0_BYPASS_BIT           (0x01UL << CSC_CACHEBP_CACHE0_BYPASS_POS)
#define CSC_CACHEBP_CACHE1_BYPASS_POS           (1)
#define CSC_CACHEBP_CACHE1_BYPASS_BIT           (0x01UL << CSC_CACHEBP_CACHE1_BYPASS_POS)
...
__STATIC_INLINE uint8_t cpusysctrl_cachebp_cache0_bypass_getb(void)
{
    return (AIC_CPUSYSCTRL->CACHEBP & CSC_CACHEBP_CACHE0_BYPASS_BIT) >> CSC_CACHEBP_CACHE0_BYPASS_POS;
}

__STATIC_INLINE void cpusysctrl_cachebp_cache0_bypass_setb(void)
{
    AIC_CPUSYSCTRL->CACHEBP |=  CSC_CACHEBP_CACHE0_BYPASS_BIT;
}

__STATIC_INLINE void cpusysctrl_cachebp_cache0_bypass_clrb(void)
{
    AIC_CPUSYSCTRL->CACHEBP &= ~CSC_CACHEBP_CACHE0_BYPASS_BIT;
}

__STATIC_INLINE uint8_t cpusysctrl_cachebp_cache1_bypass_getb(void)
{
    return (AIC_CPUSYSCTRL->CACHEBP & CSC_CACHEBP_CACHE1_BYPASS_BIT) >> CSC_CACHEBP_CACHE1_BYPASS_POS;
}

__STATIC_INLINE void cpusysctrl_cachebp_cache1_bypass_setb(void)
{
    AIC_CPUSYSCTRL->CACHEBP |=  CSC_CACHEBP_CACHE1_BYPASS_BIT;
}

__STATIC_INLINE void cpusysctrl_cachebp_cache1_bypass_clrb(void)
{
    AIC_CPUSYSCTRL->CACHEBP &= ~CSC_CACHEBP_CACHE1_BYPASS_BIT;
}
...
#define CSC_OCLKRS_OPISET_POS           (17)
#define CSC_OCLKRS_OPISET_BIT           (0x01UL << CSC_OCLKRS_OPISET_POS)
...
#define CSC_OCLKRC_OPICLR_POS           (17)
#define CSC_OCLKRC_OPICLR_BIT           (0x01UL << CSC_OCLKRC_OPICLR_POS)
