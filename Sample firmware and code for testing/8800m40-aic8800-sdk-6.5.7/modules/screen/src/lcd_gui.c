                   ...
                   DOT_PIXEL Dot_Pixel, DOT_STYLE DOT_STYLE)
{
    if(Xpoint > sLCD_DIS.LCD_Dis_Column || Ypoint > sLCD_DIS.LCD_Dis_Page) {
        dbg("GUI_DrawPoint Input exceeds the normal display range\r\n");
        return;
    }
                  ...
                  COLOR Color, LINE_STYLE Line_Style, DOT_PIXEL Dot_Pixel)
{
    if(Xstart > sLCD_DIS.LCD_Dis_Column || Ystart > sLCD_DIS.LCD_Dis_Page ||
       Xend > sLCD_DIS.LCD_Dis_Column || Yend > sLCD_DIS.LCD_Dis_Page) {
        dbg("GUI_DrawLine Input exceeds the normal display range\r\n");
        return;
    }
                    ...
                    COLOR Color, DRAW_FILL  Draw_Fill , DOT_PIXEL Dot_Pixel)
{
    if(X_Center > sLCD_DIS.LCD_Dis_Column || Y_Center >= sLCD_DIS.LCD_Dis_Page) {
        dbg("GUI_DrawCircle Input exceeds the normal display range\r\n");
        return;
    }
                 ...
                 sFONT* Font, COLOR Color_Background, COLOR Color_Foreground)
{
    ...
    if(Xpoint > sLCD_DIS.LCD_Dis_Column || Ypoint > sLCD_DIS.LCD_Dis_Page) {
        dbg("GUI_DisChar Input exceeds the normal display range\r\n");
        return;
    }
                      ...
                      sFONT* Font, COLOR Color_Background, COLOR Color_Foreground )
{
    ...
    if(Xstart > sLCD_DIS.LCD_Dis_Column || Ystart > sLCD_DIS.LCD_Dis_Page) {
        dbg("GUI_DisString_EN Input exceeds the normal display range\r\n");
        return;
    }
                ...
                sFONT* Font, COLOR Color_Background, COLOR Color_Foreground )
{
    ...
    if(Xpoint > sLCD_DIS.LCD_Dis_Column || Ypoint > sLCD_DIS.LCD_Dis_Page) {
        dbg("GUI_DisNum Input exceeds the normal display range\r\n");
        return;
    }
...
sFONT *GUI_GetFontSize(POINT Dx, POINT Dy)
{
    ...
    if (Dx > Font24.Width && Dy > Font24.Height) {
        ...
        dbg("Please change the display area size, or add a larger font to modify\r\n");
    }
    return Font;
}
/******************************************************************************
...
void GUI_Show(void)
{
    GUI_Clear(LCD_BACKGROUND);//(BLACK)
    if(sLCD_DIS.LCD_Dis_Column > sLCD_DIS.LCD_Dis_Page) { //Horizontal screen display
        ...
        dbg("LCD Draw Olympic Rings\r\n");
        uint16_t Cx1 = 110, Cy1 = 160, Cr = 15;
        ...
        dbg("LCD Draw Realistic circles\r\n");
        GUI_DrawCircle(50, 170, 20, CYAN, DRAW_FULL, DOT_PIXEL_DFT);
        GUI_DrawCircle(sLCD_DIS.LCD_Dis_Column - 50, 170, 20, CYAN, DRAW_FULL, DOT_PIXEL_DFT);

        dbg("LCD Display String \r\n");
        //GUI_DisString_EN(53, 70, "WaveShare Electronic", &Font16, LCD_BACKGROUND, BLUE);
        GUI_DisString_EN(115, 70, "AIC Semi", &Font16, LCD_BACKGROUND, BLUE);
        GUI_DisString_EN(83, 95, "2.8inch TFTLCD", &Font16, RED, BLUE);

        dbg("LCD Display Nummber \r\n");
        GUI_DisNum(120, 120, 1234567890, &Font12, LCD_BACKGROUND, BLUE);
        ...
        dbg("LCD Draw Realistic circles \r\n ");
        GUI_DrawCircle(50, 250, 20, CYAN, DRAW_FULL, DOT_PIXEL_DFT);
        GUI_DrawCircle(sLCD_DIS.LCD_Dis_Column - 50, 250, 20, CYAN, DRAW_FULL, DOT_PIXEL_DFT);

        dbg("LCD Display String \r\n ");
        //GUI_DisString_EN(70, 80, "WaveShare", &Font16, LCD_BACKGROUND, BLUE);
        //GUI_DisString_EN(68, 100, "Electronic", &Font16, LCD_BACKGROUND, BLUE);
        GUI_DisString_EN(70, 80, "AIC", &Font16, LCD_BACKGROUND, BLUE);
        GUI_DisString_EN(68, 100, "Semi", &Font16, LCD_BACKGROUND, BLUE);
        GUI_DisString_EN(70, 120, "2.8inch TFTLCD", &Font12, RED, BLUE);

        dbg("LCD Display Nummber \r\n ");
        GUI_DisNum(80, 150, 1234567890, &Font12, LCD_BACKGROUND, BLUE);
    }
}
