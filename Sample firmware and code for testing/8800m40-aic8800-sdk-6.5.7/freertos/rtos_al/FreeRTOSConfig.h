...
#else
#define configTIMER_TASK_STACK_DEPTH    ( ( unsigned short ) 384 )
#endif

#define configUSE_STATS_FORMATTING_FUNCTIONS        0
#define configUSE_STATS_FORMATTING_BUFFER_MAX_SIZE  512
...
#define configTOTAL_HEAP_SIZE            ((uint32_t)HEAP_LIMIT - (uint32_t)HEAP_BASE)
#else
...
#else
    #define configPRIO_BITS             6   /* 255 priority levels */
#endif
