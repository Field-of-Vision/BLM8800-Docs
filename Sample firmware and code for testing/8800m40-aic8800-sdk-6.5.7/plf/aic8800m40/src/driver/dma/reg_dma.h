...
#define DMA_CH_LSTCV_POS                (8)
#define DMA_CH_LSTCV_BIT                (0x01UL << DMA_CH_LSTCV_POS)
#define DMA_CH_RQPLVL_LSB               (12)
#define DMA_CH_RQPLVL_WIDTH             (0x02UL)
#define DMA_CH_RQPLVL_MASK              (((0x01UL << DMA_CH_RQPLVL_WIDTH) - 1) << DMA_CH_RQPLVL_LSB)
...
#define DMA_CH_TBL1_CNT_RH_LSB      (17)
#define DMA_CH_TBL1_CNT_RH_WIDTH    (0x02)
#define DMA_CH_TBL1_CNT_RH_MASK     (((0x01UL << DMA_CH_TBL1_CNT_RH_WIDTH) - 1) << DMA_CH_TBL1_CNT_RH_LSB)
...
#define DMA_CH_WRPADR_POS           (22)
#define DMA_CH_WRPADR_BIT           (0x01UL << DMA_CH_WRPADR_POS)
#define DMA_CH_WRPDADR_POS          (23)
#define DMA_CH_WRPDADR_BIT          (0x01UL << DMA_CH_WRPDADR_POS)
...
#define DMA_CH_SWT_MODE_LSB         (26)
#define DMA_CH_SWT_MODE_WIDTH       (0x02UL)
#define DMA_CH_SWT_MODE_MASK        (((0x01UL << DMA_CH_SWT_MODE_WIDTH) - 1) << DMA_CH_SWT_MODE_LSB)
...
#define DMA_CH_TBL1_CNT_RL_LSB          (17)
#define DMA_CH_TBL1_CNT_RL_WIDTH        (0x0FUL)
#define DMA_CH_TBL1_CNT_RL_MASK         (((0x01UL << DMA_CH_TBL1_CNT_RL_WIDTH) - 1) << DMA_CH_TBL1_CNT_RL_LSB)
...
#define DMA_CH_WRPMADR_LSB          (0)
#define DMA_CH_WRPMADR_WIDTH        (0x1CUL)
#define DMA_CH_WRPMADR_MASK         (((0x01UL << DMA_CH_WRPMADR_WIDTH) - 1) << DMA_CH_WRPMADR_LSB)
#define DMA_CH_SAH4_LSB             (28)
#define DMA_CH_SAH4_WIDTH           (0x04UL)
#define DMA_CH_SAH4_MASK            (((0x01UL << DMA_CH_SAH4_WIDTH) - 1) << DMA_CH_SAH4_LSB)
...
#define DMA_CH_WRPJADR_LSB          (0)
#define DMA_CH_WRPJADR_WIDTH        (0x1CUL)
#define DMA_CH_WRPJADR_MASK         (((0x01UL << DMA_CH_WRPJADR_WIDTH) - 1) << DMA_CH_WRPJADR_LSB)
#define DMA_CH_DAH4_LSB             (28)
#define DMA_CH_DAH4_WIDTH           (0x04UL)
#define DMA_CH_DAH4_MASK            (((0x01UL << DMA_CH_DAH4_WIDTH) - 1) << DMA_CH_DAH4_LSB)
...
#define DMA_CH_LLINADR_LSB          (0)
#define DMA_CH_LLINADR_WIDTH        (0x20UL)
#define DMA_CH_LLINADR_MASK         (((0x01UL << DMA_CH_LLINADR_WIDTH) - 1) << DMA_CH_LLINADR_LSB)
...
#define DMA_CH_TBL1_SSZ_LSB             (0)
#define DMA_CH_TBL1_SSZ_WIDTH           (0x1CUL)
#define DMA_CH_TBL1_SSZ_MASK            (((0x01UL << DMA_CH_TBL1_SSZ_WIDTH) - 1) <<DMA_CH_TBL1_SSZ_LSB)
#define DMA_CH_LLINADRH4_LSB            (28)
#define DMA_CH_LLINADRH4_WIDTH          (0x04UL)
#define DMA_CH_LLINADRH4_MASK           (((0x01UL << DMA_CH_LLINADRH4_WIDTH) - 1) << DMA_CH_LLINADRH4_LSB)
...
#define DMA_CH_TBL1_DSZ_LSB             (0)
#define DMA_CH_TBL1_DSZ_WIDTH           (0x1CUL)
#define DMA_CH_TBL1_DSZ_MASK            (((0x01UL << DMA_CH_TBL1_DSZ_WIDTH) - 1) <<DMA_CH_TBL1_DSZ_LSB)
