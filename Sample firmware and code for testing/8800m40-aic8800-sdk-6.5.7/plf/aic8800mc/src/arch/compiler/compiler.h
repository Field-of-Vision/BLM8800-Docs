...
#define __UNINITVAR __attribute__ ((section("UNINITVAR")))
...
#if !defined(CFG_RAM_OPT) && !(defined(CFG_BT_STACK) || defined(CFG_BLE_STACK))
#define __BSS2_RAM __attribute__ ((section("BSS2_RAM")))
#else
#define __BSS2_RAM
#endif
